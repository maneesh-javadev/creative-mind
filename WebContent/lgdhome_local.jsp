		...
		<div id="contentin">
			<table width="100%" class="tbl_no_brdr">
				...
				<div class="new_listmenu">
					<ul>
						<li><a target="_blank" 
							 href="<%=request.getContextPath()%>/media/LGD_CBT_Offline/LGD.mp4">CBT (Offline)</a></li>
						<li><a target="_blank" rel="gb_page_center[700, 500]" 
							 href="<%=request.getContextPath()%>/media/LGD_CBT_Offline/index.html">CBT (Online)</a></li>
						<li><a target="_blank"
							 href="<%=request.getContextPath()%>/media/LocalGovernmentDirectorySWDemo.pptx">Presentation</a></li>
						<li><a target="_blank"
							 href="<%=request.getContextPath()%>/media/LGD_Brochure.pdf">Brochure</a></li>
						<li><a target="_blank"
							 href="<%=request.getContextPath()%>/media/LGD_updated_manual.pdf">User Manual</a></li>
					</ul>
				</div>
						</div>
					</td>
