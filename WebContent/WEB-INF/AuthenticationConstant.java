...
public abstract class AuthenticationConstant {
	...
	public static final String VALID_APPLICATION_EXT = ".htm";
	public static final String VALID_APPLICATION_LOGIN_EXT =".do";
	public static final String VALID_CITIZEN_EXT = ".htm";
	public static final String LGD_APPLICATION_MSG = "Local Government Directory : Invalid file request";
	...
	public static String getAuthenticationBundle(String key, String... params) { 
		  ...
		  try { 
		    if (params == null) { 
		      ...
		      message = MessageFormat.format(ResourceBundle.getBundle(AUTHENTICATION_RESOURCE_FILE_PATH, Locale.ENGLISH).getString(key), params); 
		    } 
