...
<body >
		...
		<div id="frmcontent">
			<div class="frmhd">
					<h2 class="Subtitle"><spring:message htmlEscape="true"  code="Label.STATEHISTORY" ></spring:message></h3>
							 ...
							 <table width="100%" class="tbl_with_brdr">
								<tr>
									<td width="" align="center">
										     <tr class="tblRowTitle tblclear">
												...
												<td width="15%" rowspan="2"><spring:message htmlEscape="true" code="Label.STATECODE" text="STATE CODE"></spring:message></td>
												<td width="15%" rowspan="2"><spring:message htmlEscape="true" code="Label.STATEVERSION"></spring:message></td>
												<td width="50%" rowspan="2"><spring:message htmlEscape="true" code="Label.STATENAMEINENGLISH"></spring:message></td>
								...
								<tr><td><br/></td></tr>
											 ...
											 <tr class="tblRowB">
												...
												<%-- <td align="left"><c:out value="${stateHistoryDetail.description}" escapeXml="true"></c:out></td> --%>
												<%-- <c:if test="${stateHistoryDetail.timeStatmp ne '' }"> --%>
												...
												<a href="#"><img
																			...
																			onclick="javascript:checkFileExists('${stateHistoryDetail.fileLocation}','${stateHistoryDetail.timeStatmp}');"
																			width="18" height="19" border="0" alt="State Details" />
												</a>
												<a href="fileToDownloads.do?fileLocation=${stateHistoryDetail.fileLocation}&timeStatmp=${stateHistoryDetail.timeStatmp}&<csrf:token uri='fileToDownloads.do'/>"><img src="images/gvt.order.png" name="viewAttachment"
													width="22" height="18" alt="View" border="0"/></a>
												</td> --%>
												<%-- </c:if>
												<c:if test="${stateHistoryDetail.timeStatmp eq '' }">
