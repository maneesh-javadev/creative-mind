	...
	<div id="frmcontent">
		...
		<div class="frmhd">
			<table width="100%" class="tbl_no_brdr">
				<tr>
					<td><spring:message code="Label.SHIFTVILLAGESUBDISTRICT" htmlEscape="true"></spring:message>
					</td>
										...
										<div id="tab_panel">
											<ul>
												<li><a href="#" class="current" id="tab1_header"  onclick="tabdisplay(id);"><spring:message
															code="Label.GOVTORDERDETAILS" htmlEscape="true"></spring:message> </a></li>
													...
													<div class="frmpnlbg">
														<div class="frmtxt">
															...
															code="Error.SOURCESTATE" htmlEscape="true"></spring:message></span>
																...
																<tr>
																	<td><spring:message code="Label.SOURCEDISTRICT" htmlEscape="true"></spring:message><br />
															...
															code="Error.SOURCEDISTRICT" htmlEscape="true"></spring:message></span>
																...
																<tr>
																	<td><spring:message code="Label.SOURCESUBDISTRICT" htmlEscape="true"></spring:message><br />
																		<form:select path="subdistrictNameEnglish"
																			class="combofield" style="width: 150px" htmlEscape="true"
																			id="ddSourceSubDistrict"
																			onchange="getTargetSubDistrictandVillageList(this.value)">
																		</form:select><span class="errormsg" id="ddSourceSubDistrict_error"><spring:message
															code="Error.SOURCESUBDISTRICT" htmlEscape="true"></spring:message></span>
																	</td>
																</tr>
																<tr>
														...
														<div class="frmtxt">
															...
															<table width="100%" class="tbl_no_brdr">
																...
																<tr>
																	<td width="14%" rowspan="9">&nbsp;</td>
																	<td width="86%"><spring:message
																			code="Label.TARGETSUBDISTRICT" htmlEscape="true"></spring:message><br />
																		<form:select path="subdistrictNameEnglish"
																			class="combofield" style="width: 150px" htmlEscape="true"
																			id="ddTargetSubDistrict">
																		</form:select><span class="errormsg" id="ddTargetSubDistrict_error"><spring:message
																		code="Error.TARGETSUBDISTRICT" htmlEscape="true"></spring:message></span>
																	</td>
																</tr>
																<tr>
																	<td><br /> <label></label></td>
															...
															<table width="650" class="tbl_no_brdr">
																...
																<tr>
																	<td width="275" rowspan="3" align="center"><spring:message
																			code="Label.AVAILABLEVILLAGE" htmlEscape="true"></spring:message><br />
																	...
																	<td width="275" rowspan="3" align="center"><spring:message
																			code="Label.SELECTVILLAGE" htmlEscape="true"></spring:message><br /> <form:select
																		...
																		<spring:message
																				code="Error.VILLAGE" htmlEscape="true"></spring:message>
																		</span>
																	</td>
																</tr>
