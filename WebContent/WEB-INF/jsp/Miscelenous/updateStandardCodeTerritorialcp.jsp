		...
		<input type="hidden" name="Tiertype" id="Tiertype" value="<c:out value='${Tiertype}' escapeXml='true'></c:out>"/>
                    <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Update Standard Code/Local Names(Traditional)</h3>
                                </div>
              <c:if test="${empty distuser}">          
                 <div class="box-body">
                  <div class="form-group">
					...
					<div class="col-sm-6" >
							<form:select path="entityName" htmlEscape="true"  class="form-control" id="entity" onchange="getDetails();"><form:option value="" htmlEscape="true" >
        ...
        <div class="box-footer">
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
				  ...
				  <button type="button" name="Submit2" class="btn btn-warning"  onclick="javascript:go('standard_Code_Territorial.htm');" ><spring:message code="Button.CLEAR"></spring:message></button> 
