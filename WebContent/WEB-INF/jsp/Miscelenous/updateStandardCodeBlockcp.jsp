	...
	<section class="content">
		...
		<input type="hidden" name="Tiertype" id="Tiertype" value="<c:out value='${Tiertype}' escapeXml='true'></c:out>"/>
              ...
              <div class="box-header with-border">
                                    <h3 class="box-title">Update Standard Code/Local Names(Block) </h3>
                                </div>         
                 <div class="box-body">
				...
				<div id="IPAN" style="Display: none" class="form-group">
                    ...
                    <div class="col-sm-6">
                     <form:select path="districtPanchyat" class="combofield" id="dispanchayat"  onchange="remove_error1()" onfocus="validateOnFocus('ddDistrict');" onblur="vlidateOnblur('ddDistrict','1','15','c');" htmlEscape="true">
											<form:option value="" htmlEscape="true">
			   ...
			   <div id="VPAN" style="Display: none">
                        <div class="form-group">
                          <label class="col-sm-3 control-label"><spring:message code="Label.DISTRICTPANCHYATNME" htmlEscape="true"></spring:message><font color="red">*</font> </label>
                            <div class="col-sm-6">
                              <form:select path="disPanchyat" class="combofield" id="dispanchayatforvp"
        ...
        <div class="box-footer">
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
				  ...
				  <button type="button" name="Submit2" class="btn btn-warning"  onclick="javascript:go('standard_Code_Block.htm');" ><spring:message code="Button.CLEAR"></spring:message></button> 
			 ...
			 <div class="col-sm-6">
			   <form:select path="entityName" class="form-control" id="entity" onchange="getDetails_district();">
					...
					<div id="DISVPAN" style="Display: none">
							...
							<div class="col-sm-6">
							  <form:select htmlEscape="true" path="disPanchyat" class="combofield"
		...
		<div class="box-footer">
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
				  ...
				  <button type="button" name="Submit2" class="btn btn-warning" value="<spring:message code="Button.CLEAR"></spring:message>" onclick="javascript:go('standard_Code_Block.htm');" ></button>
