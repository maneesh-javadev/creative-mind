...
<body onload="hideAll();">
	...
	<div class="frmhd">
		...
		<h3 class="subtitle">
			Update Standard Code/Local Names(Block) 
		</h3>
		<%-- <ul class="listing">
				...
				<div class="frmtxt">
					...
					<c:if test="${empty distuser}">
						...
						<div class="search_criteria">
							<ul class="blocklist">
								...
								<div id="ORGUNIT" style="Display:none" >
											...
											<label>
											<form:select path="" class="combofield" id="topLevelEntityType"	onchange="getTopLevelEntityByType(this.value);">
							...
							<li style="Display:none" id="blockLI">
								...
								<li>
									...
									<div id="VPAN" style="Display: none">
										...
										<ul class="blocklist">
											<li><label for="dispanchayatforvp"><spring:message code="Label.DISTRICTPANCHYATNME" htmlEscape="true"></spring:message><font color="red">*</font></label> 
						...
						<div class="btnpnl">
							...
							<input type="button" name="Submit2" class="btn" value="<spring:message code="Button.CLEAR"></spring:message>" onclick="javascript:go('standard_Code_Block.htm');" /> <input type="button" name="Cancel" class="btn"
