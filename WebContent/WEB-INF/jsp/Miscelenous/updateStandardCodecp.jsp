                ...
                <div class="row">
                    ...
                    <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><spring:message code="Label.UOTHERSTANDARDCODESCH" htmlEscape="true" text="Update Other Standard Codes/Local Names(Landregion)"></spring:message></h3>
                                </div>
              <c:if test="${empty distuser}">          
                 <div class="box-body">
                  <div class="form-group">
								<label for="ddSourceDistrict" class="col-sm-3 control-label"><spring:message code="Label.ENTITYSTANDARD" htmlEscape="true"></spring:message><font color="red">*</font></label>
					<div class="col-sm-6" >
				...
				<div class="form-group" style="Display:none" id="subdistrictLI">
					...
					<div id="ADMINLEVEL" style="Display: none">
				     ...
				     <div id="DR" style="Display: none" class="form-group">
                       <label for="ddDistrict" class="col-sm-3 control-label"> <spring:message code="Label.DISTRICT" htmlEscape="true"></spring:message> <font color="red">*</font></label>
							<div class="col-sm-6">
							  	<form:select htmlEscape="true" path="districtCode" class="form-control" id="ddDistrict"  onchange="remove_error1()" onfocus="validateOnFocus('ddDistrict');" onblur="vlidateOnblur('ddDistrict','1','15','c');">
				...
				<div id="IPAN" style="Display: none" class="form-group">
                    ...
                    <div class="col-sm-6">
                      <form:select path="districtPanchyat" class="form-control" id="dispanchayat"  onchange="remove_error1()" onfocus="validateOnFocus('ddDistrict');" onblur="vlidateOnblur('ddDistrict','1','15','c');" htmlEscape="true">
											<form:option value="" htmlEscape="true">
			   ...
			   <div id="VPAN" style="Display: none">
                        <div class="form-group">
                          <label class="col-sm-3 control-label"><spring:message code="Label.DISTRICTPANCHYATNME" htmlEscape="true"></spring:message><font color="red">*</font> </label>
                            <div class="col-sm-6">
                              <form:select path="disPanchyat" class="form-ccontrol" id="dispanchayatforvp" onchange="getIntermediatePanchayatbyDcode(this.value);">
													<form:option value="" htmlEscape="true">
														<esapi:encodeForHTMLAttribute><spring:message code="Label.SELECTDISTICTPANCHAYAT" htmlEscape="true"></spring:message></esapi:encodeForHTMLAttribute>
													</form:option>
                         ...
                         <c:if test="${Tiertype eq 3}">
		                        <div class="form-group">
		                               ...
		                               <label for="vilpanchayat" class="col-sm-3 control-label"><spring:message code="Label.INTERPANCHYATNME" htmlEscape="true"></spring:message> <font color="red">*</font></label>
		                                   <div class="col-sm-6">
		                                    <form:select htmlEscape="true" path="intermediatePanchyat" class="form-control" id="vilpanchayat"  onchange="remove_error2();" onfocus="validateOnFocus('ddSubdistrict');" onblur="vlidateOnblur('ddSubdistrict','1','15','c');">
															</form:select>
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-6">
                             <form:select htmlEscape="true" path="districtCode" class="form-control" id="ddDistrict2" 
                         ...
                         <label for="ddSubdistrict" class="col-sm-3 control-label"><spring:message code="Label.SELECTSUBDISTRICT" htmlEscape="true"></spring:message><font color="red">*</font> </label> 
                          <div class="col-sm-6">
                            <form:select htmlEscape="true" path="subdistrictCodes" class="form-control" id="ddSubdistrict"
													 onchange="remove_error2();" onfocus="validateOnFocus('ddSubdistrict');" onblur="vlidateOnblur('ddSubdistrict','1','15','c');">
												</form:select>
        ...
        <div class="box-footer">
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
				  ...
				  <button type="button" name="Submit2" class="btn btn-warning"  onclick="javascript:go('standard_Code.htm');" ><spring:message code="Button.CLEAR"></spring:message></button> 
                   ...
                   <spring:bind path="stateCode"><input type="hidden" class="frmfield" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" escapeXml="true"></c:out>" />
				   </spring:bind>
                 </div>
           </div>   
       </div> 
			 ...
			 <div class="col-sm-6">
			   <form:select path="entityName" class="form-control" id="entity" onchange="getDetails_district();">
					...
					<div id="DTR" style="Display: none" class="form-group">
                            ...
                            <div class="col-sm-6">
                              <form:select htmlEscape="true"  path="subdistrictCodes" class="form-control" id="ddSubdistrict"  onchange="remove_error4();" onfocus="validateOnFocus('ddSubdistrict');" onblur="vlidateOnblur('ddSubdistrict','1','15','c');">
					...
					<div id="DISIPAN" style="Display: none" class="form-group">
                          <label for="distleveldispanchayat" class="col-sm-3 control-label"> <spring:message code="Label.DISTRICTPANCHYATNME" htmlEscape="true"></spring:message> <font color="red">*</font>
                           ...
                           <div class="col-sm-6">
                             <form:select htmlEscape="true"  path="districtPanchyat" class="form-control" id="distleveldispanchayat"  onchange="remove_error1()" onfocus="validateOnFocus('ddDistrict');" onblur="vlidateOnblur('ddDistrict','1','15','c');">
											<form:option value="" htmlEscape="true">
											<esapi:encodeForHTMLAttribute><spring:message code="Label.SELECTDISTICTPANCHAYAT" htmlEscape="true"></spring:message></esapi:encodeForHTMLAttribute>
											</form:option>
											<form:options htmlEscape="true"  items="${districtPanchayatList}" itemLabel="localBodyNameEnglish" itemValue="localBodyCode" />
