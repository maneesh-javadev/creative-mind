                ...
                <div class="row">
                    ...
                    <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Update Standard Code/Local Names(Admin)</h3>
                                </div>
              <c:if test="${empty distuser}">          
					...
					<div class="col-sm-6" >
							<form:select path="entityName" htmlEscape="true"  class="form-control" id="entity" onchange="getDetails();">
										...
										<option value="adminLevel">
													<spring:message htmlEscape="true" code='Label.ADMINUNITLEVEL'></spring:message>
											</option>
											<option value="adminEntity">
													<spring:message htmlEscape="true" code='Label.AdminEntity'></spring:message>
											</option>
											<option value="dept">
													<spring:message htmlEscape="true" code='Label.Department'></spring:message>
											</option>
											
											<option value="org">
													<spring:message htmlEscape="true" code='Label.Organization'></spring:message>
											</option>
											<option value="orgunit">
													<spring:message htmlEscape="true" code='Label.Organization.Unit'></spring:message>
											</option>
				...
				<div class="form-group" style="Display:none" id="subdistrictLI">
							...
							<div class="form-group" style="Display:none" id="villageLI">
               					...
               					<div class="col-sm-6">
               					<select id="village" name="entityCodes" class="" onchange="removeVilageError();">
				...
				<div id="IPAN" style="Display: none" class="form-group">
                    ...
                    <div class="col-sm-6">
                      <form:select path="districtPanchyat" class="" id="dispanchayat"  onchange="remove_error1()" onfocus="validateOnFocus('ddDistrict');" onblur="vlidateOnblur('ddDistrict','1','15','c');" htmlEscape="true">
											<form:option value="" htmlEscape="true">
			   ...
			   <div id="VPAN" style="Display: none">
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-sm-6">
                             <form:select htmlEscape="true" path="districtCode" class="" id="ddDistrict2" 
