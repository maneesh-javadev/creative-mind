...
<body onload="hideAll();">
	...
	<div class="frmhd">
		...
		<h3 class="subtitle">
			Update Standard Code/Local Names(Panchayat)
		</h3>
		<%-- <ul class="listing">
				...
				<div class="frmtxt">
					...
					<c:if test="${empty distuser}">
						...
						<div class="btnpnl">
							...
							<input type="button" name="Submit2" class="btn" value="<spring:message code="Button.CLEAR"></spring:message>" onclick="javascript:go('standard_Code_Panchayat.htm');" /> <input type="button" name="Cancel" class="btn"
