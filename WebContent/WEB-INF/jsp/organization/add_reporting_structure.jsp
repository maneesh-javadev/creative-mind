		...
		<div class="frmpnlbrdr">
			<form:form id="designationReportingFormOrg" name="designationReportingForm" action="add_reporting_structure.htm" method="post" commandName="designationReportingForm">
				...
				<div class="frmpnlbg">
						...
						<div class="block">
							<ul class="blocklist">
								<li>
									...
									<form:select path="orgTypeCode" style="width: 150px" id="orgType" htmlEscape="true" class="combofield"
										onchange="displayLoadingImage();resetDetails(false);getOrgbyTypeAtLevel(this.value,'0','0');hideLoadingImage();">
								...
								<li>
									...
									<form:select id="orgCode" path="orgCode" style="width: 250px" class="combofield" htmlEscape="true"
								...
								<li>
									<label>Select Level&nbsp;<span class="errormsg">*</span></label><br /> 
										<form:select path="locatedAtLevel" id="locatedAtLevel" class="combofield" style="width:150px" htmlEscape="true"
						...
						<div>
							<ul class="listing">
								...
								<li>
									...
									<form:select htmlEscape="true" path="report" class="combofield" style="width:150px" id="RdesignationCode0" disabled="true"></form:select> 
					...
					<div class="btnpnl">
				        <input type="submit" name="Submit" value="<spring:message htmlEscape="true"  code="Button.SAVE"></spring:message>" onclick="return populateOrg();" style="width: 100px;"/>
       					<input type="button"  value="Clear" onclick="javascript:location.href='add_reporting_structure_state.htm?<csrf:token uri="add_reporting_structure_state.htm"/>'"  style="width: 100px;"/>
       					<input type="button" value="<spring:message htmlEscape="true"  code="Button.CLOSE"></spring:message>" onclick="javascript:location.href='home.htm?<csrf:token uri="home.htm"/>'" style="width: 100px;"/>
	               </div>
				</div>
			</form:form>
		</div>
