						...
						<spring:message htmlEscape="true"  code="Label.VIEWNEWDESIGNATION"></spring:message></label></td></tr>
						      <tr class="tblRowTitle tblclear">
							   <td width="15%" ><spring:message htmlEscape="true"  code="Label.DESIGCODE"></spring:message></td>
								<td width="40%" ><spring:message htmlEscape="true"  code="Label.DESIGNAME"></spring:message></td>
								<td width="15%""><spring:message htmlEscape="true"  code="Label.LOCATEDAT"></spring:message></td>
								<td width="15%" ><spring:message htmlEscape="true"  code="Label.ISTOPDESIG"></spring:message></td>
								<td width="15%" ><spring:message htmlEscape="true"  code="Label.ISMULTIPLE"></spring:message></td>
							  </tr>
							  <c:forEach var="NewDesig" varStatus="fullRow" items="${NewDesig}">
													<tr class="tblRowB">
														<td width="15%"><c:out value="${NewDesig.designationCode}" escapeXml="true"></c:out></td>
														<td width="40%"><c:out value="${NewDesig.designationName}" escapeXml="true"></c:out></td>
														<td width="15%"><c:out value="${NewDesig.locatedAtLevel}" escapeXml="true"></c:out></td>
														<td width="15%"><c:out value="${NewDesig.topDesignation}" escapeXml="true"></c:out></td>
														<td width="15%"><c:out value="${NewDesig.ismultiple}" escapeXml="true"></c:out></td>
													</tr>
								  </c:forEach>
						</table>
