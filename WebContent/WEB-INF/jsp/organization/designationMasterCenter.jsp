...
<body oncontextmenu="return false" onkeypress="disableCtrlKeyCombination(event);"
	...
	<div id="frmcontent">
			...
			<table width="100%" class="tbl_no_brdr">
				<tr>
					<td><spring:message htmlEscape="true"
							code="Label.CREATEDESIGNATIONCENTER"></spring:message>
					</td>
		...
		<div class="frmpnlbrdr">
			<form:form id="designationForm" commandName="designationForm" action="designaton_master_center.htm" method="POST" onsubmit="cursorwait();" enctype="multipart/form-data">
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="designaton_master_center.htm"/>" />
								...
								<tr>
									...
									<td width="86%" style="padding: 0px">
										<table width="400" class="tbl_no_brdr">
											<td><label id="lblOrgTypelIst"><spring:message
														htmlEscape="true" code="Label.ORGTYPELIST"></spring:message>
											</label> <span class="errormsg">*</span> <br /> <form:select
													path="orgType" style="width: 200px" id="orgType"
													class="combofield"
													onchange="getOrgbyTypeAtLevel(this.value,'0','0')"
													onfocus="validateOnFocus('orgType');helpMessage(this,'orgType_msg');"
													htmlEscape="true"
													onblur="vlidateOnblur('orgType','1','15','c');hideHelp();"
											...
											<tr>
												<td><label id="lblOrgList"><spring:message
														...
														class="combofield" onchange="getOrgAtLevel(this.value,'C')"
											...
											<table width="300" class="tbl_no_brdr">
												...
												<tr>
													<td><label id="lbldesg0" style="color: red"></label> <form:input
															path="desgName" id="desgName0" maxlength="50" type="text" onkeypress="validateforTextandspace();"
															class="frmfield" style="width: 200px" />&nbsp;&nbsp;
														
														<%-- <div id="desgName0_error" class="error">Top Designation Name is required</div>
														<div id="desgName0_msg" style="display:none"><spring:message code="Label.SELECTLEVEL" htmlEscape="true"/></div>
														<div class="errormsg" id="desgName0_error1"><form:errors path="topDesigName" htmlEscape="true"/></div>   
														<div class="errormsg" id="desgName0_error2" style="display: none" ></div>	
														<div style="height: 15px; padding-top: 3px;" class="errormsg"></div> --%>
													</td>
													<td><label id="lblreport0" style="color: red"></label>
														<form:input path="desgNameLocal" id="desgNameLocal0" maxlength="50"
										...
										<table width="650" class="tbl_no_brdr">
											...
											<tr>
												...
												<td width="100" align="center"><input type="button"
													...
													<form:input path="designationCode" name="designationCode" id="designationCode1" type="hidden"/> 
											...
											<tr>
												<td colspan="4">
													<div id="dynamicDiv" style="width: 100%"></div></td>
											</tr>
										</table>
