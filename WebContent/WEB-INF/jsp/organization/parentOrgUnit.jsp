...
<body>
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="setParentOrgUnit.htm" method="POST" id="form1"
				commandName="orgUnitForm">
				<input type="hidden" name="<csrf:token-name/>"
					value="<csrf:token-value uri="setParentOrgUnit.htm"/>" />
						...
						<div class="frmtxt">
							...
							<div class="margintoleft">
								<ul class="blocklist">
									...
									<li><br />
									<label><spring:message code="Label.SELOrganization"
												text="Select Organization" htmlEscape="true"></spring:message></label><span
										class="errormsg">*</span><br />
										<div id="parentAdminOrg" style="color: red;"></div> <br /> <label>
											<form:select htmlEscape="true" path="orgCode"
												class="combofield" id="orgCode"
												onchange="getParentLevelEntity()" style="width: 260px">
												<form:option value="0" htmlEscape="true">
													<spring:message code="Label.SELECT" text="-slect"></spring:message>
												</form:option>
									...
									<li><label><spring:message
												code="Label.SELOrgLevel"
												text="Select Level  of Organization" htmlEscape="true"></spring:message></label>
										...
										<label> <form:select htmlEscape="true"
												...
												onchange="getparentOrganizations(this.value);" id="orgType"
												style="width: 260px">
												<form:option value="0">
													<spring:message code="Label.SELECT" text="-slect -"></spring:message>
												</form:option>
											...
											<div class="ms_container">
												...
												<div class="ms_buttons">
													<input id="src2Target1" class="bttn" type="button"
														...
														type="button" style="width: 50px; margin-left: 27%;"
