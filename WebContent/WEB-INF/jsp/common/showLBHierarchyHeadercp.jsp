...
var registerCallDynamicHierarchy = function(obj) {
	 ...
	 $(localBodyTypeElement).each(function(index){
		 ...
		 if((obj.selectedIndex  > index) && (obj.value != localbodyTypeCode )){
			...
			/* divTemplate.append(templateLabel);
...
$(window).load(function () {
	...
	if (!$_checkEmptyObject(_lb_type_value)) {
     ...
     <div class="box-header subheading">
      ...
      <div id="divCenterAligned" class="form-group">
        <c:if  test="${PANCHAYAT_TYPE ne 'U'}">
         <label class="col-sm-3 control-label"><spring:message code='Label.Selecthierarchylevel' htmlEscape='true'/> <span class="mandatory">*</span> </label>
          <div class="col-sm-6">
   ...
   <label class="col-sm-3 control-label"><spring:message code='Label.SELECTLOCALBODYTYPE' htmlEscape='true'/> <span class="mandatory">*</span> </label>
   <div class="col-sm-6">
