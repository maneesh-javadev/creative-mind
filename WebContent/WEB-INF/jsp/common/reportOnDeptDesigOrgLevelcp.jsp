                ...
                <div class="row">
                    ...
                    <div class="box">
                                <div class="box-header with-border">
                                    <h3 class="box-title"><spring:message htmlEscape="true"  text="Organization Department Report"></spring:message></h3>
                                </div>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
								<label  class="col-sm-4 control-label"><spring:message	code="Label.SELDeptAdministrationUNIT" text="Type of Administrative unit Level" htmlEscape="true"></spring:message> <span class="mandatory">*</span></label>
								<div class="col-sm-6" >
								      <label class="radio-inline">
								       <form:radiobutton path="radioUser" id="radioUser" name="radioUser" value="1"  checked="checked" onclick="stateList();showCentreORState();" onfocus="" onblur="hideHelp('helpDiv')"/>
											        <spring:message code="Label.STATELEVEL"></spring:message></label>
								       ...
								       <form:radiobutton path="radioUser" id="radioUser" name="radioUser" value="0" checked="checked" class="frmfield" onclick="showCentreORState();getOrganizationMinistryList();" onfocus="" onblur="hideHelp('helpDiv')"/>
													<spring:message code="Label.CENTRELEVEL" text="Center"></spring:message></label>		        
								</div>
							</div>
							
							
								<div class="form-group" id="Statelabel">
								<label class="col-sm-4 control-label" for="statelabel"><spring:message code="Label.SELECTSTATE"></spring:message> <span class="mandatory">*</span> </label>
									<div class="col-sm-6">
										 <form:select name="statelabel" path="code" id="statelabel" onchange="getAdminUnitDepartmentDetailsOrganise(this.value);clearMessage(this.id);" class="form-control">
																<option value="0"><spring:message code="common.select" text="Select"/></option>
														 </form:select>
												<div id="err_statelabel"class="mandatory label"></div>
									 </div>			
						        </div>
						        
							<div class="form-group" id="tdMinistry">
								<label class="col-sm-4 control-label"for="tdMinistry" ><spring:message htmlEscape="true"  code="Label.SELMIN"></spring:message><span class="mandatory">*</span></label>
								<div class="col-sm-6">
								...
								<div id="err_minlabel" class="mandatory label"></div>
								</div>  		
							</div>
					...
					<div class="form-group"  id="tdMinDepartment">
						<label class="col-sm-4 control-label"><spring:message htmlEscape="true" code="Label.SELORG"></spring:message><span class="mandatory">*</span> </label>
						   <div class="col-sm-6">	 
							<form:select path="orgUnitCode" id="tdMinDepartmentt" onchange="getAdminUnitDepartmentDetailsOrganizeationer(this.value);clearMessage(this.id);" class="form-control">
														<form:option value="0">
															<spring:message htmlEscape="true" code="Label.SELECT"></spring:message>
														</form:option>
							</form:select>
							<div id="err_MinDptlabel" class="mandatory label"></div>
						</div>		 
					</div>
							...
							<div class="form-group" id="tdDepartment">
					            <label class="col-sm-4 control-label"><spring:message htmlEscape="true" code="Label.SELORG"></spring:message></label>
							    <div class="col-sm-6">
						...
						<div class="col-sm-6">
							<form:select path="unitLvlDept" id="adminUnitLevelName" onchange="getOrganizationParent(this.value);clearMessage(this.id);" class="form-control">
															<form:option value="0">
																<spring:message htmlEscape="true" code="Label.SELECT"></spring:message>
															</form:option>
							</form:select>
							<div id="err_unitLvlClabel" class="mandatory label"></div>
						   </div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								...
								<div id="captchaErrormsg" class="mandatory"><form:errors path="captchaAnswer"/></div>
							 </div>
						</div> 
    ...
    <div class="box-footer">
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
                   <button type="button" name="Submit" class="btn btn-success" onclick="validateFormData();"  ><i class="fa fa-floppy-o"></i> <spring:message htmlEscape="true"  code="Get Data "></spring:message> </button>
                 </div>
           </div>   
       </div>
