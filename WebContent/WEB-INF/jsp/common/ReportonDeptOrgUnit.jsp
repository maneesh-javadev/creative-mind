	...
	function validateFormData() {
		...
		if(radioUser == 1) {
			...
			<body onload="showCentreORState();getOrganizationMinistryList();">
				<div id="frmcontent">
				<div class="frmhd">
					<h3 class="subtitle"><spring:message htmlEscape="true"  code="" text="Organization Department Report"></spring:message></h3>
					...
					<div class="clear"></div>
             	         ...
             	         <form:form commandName="viewDeptforadmin" action="viewOrganizationUnitReport.do" method="POST" name="OrgUnitForm">
								...
								<div class="frmpnlbg" id='showbystatelinelevel' >
									<div class="frmtxt">
										   ...
										   <div class="block">
											...
											<div>
												<input type="button" name="Submit"  onclick="validateFormData();"  value=<spring:message htmlEscape="true"  code="Get Data "></spring:message>/> 
										    </div>
									<div class="clear"></div>
								</div>
							</div>
