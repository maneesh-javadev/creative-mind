	...
	<body onload="setStateCode('${entityName}')">
		<section class="content">
                <div class="row">
                  ...
                  <form:form  method="POST" action="nofnStates.do" commandName="viewDeptforadmin" class="form-horizontal">
                    ...
                    <div class="box-header with-border">
                      <h4>National Optical Fibre Network Panchayat</h4>
                    </div>
                        <div class="box-body">
                        ...
                        <div class="form-group">
                            	<label  class="col-sm-4 control-label" for="entity"><spring:message code="captcha.message"	htmlEscape="true" /><span class="mandatory">*</span></label>									
								  <div class="col-sm-6">	
								   <input type="text" id="captchaAnswer" name="captchaAnswer" autocomplete="off" maxlength="5" class="form-control" width="10%"/>
