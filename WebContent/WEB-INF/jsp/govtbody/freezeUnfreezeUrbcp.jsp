						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-body" id="customAlertbody">
		                        	...
		                        	<hr />
		                        	<br></br>
		                        	 <table id="tblSample" class="table table-bordered table-hover" width="80%">  
                                                	<thead> 
                                                 	<tr >
										...
										<tbody>
											<c:forEach var="districtlist" varStatus="listDepartmentRow" items="${districtList}">
												...
												<tr id="${districtCode}" 
													...
													<c:if test="${districtlist.status eq 1}">
													<td id="dstatus${listDepartmentRow.index+1}">
														<c:out value="Freezed"></c:out>
													</td>
													</c:if>
													<c:if test="${districtlist.status eq 0}">
													<td id="dstatus${listDepartmentRow.index+1}">
														<c:out value="UnFreezed"></c:out>
													</td>
													</c:if>
													<c:if test="${districtlist.status eq null}">
													<td id="dstatus${listDepartmentRow.index+1}">
