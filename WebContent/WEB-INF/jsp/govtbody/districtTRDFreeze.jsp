...
<body>
	...
	<div class="form_stylings">
		...
		<!-- Main Heading starts -->
		<div class="header">
			<h3><spring:message code="Label.freeze.trdLocalBodyFreeze"/></h3>
			<ul class="item_list">
		...
		<div class="page_content">
			<div class="form_container">
				<form:form action="freezeDistrictTRD.htm" method="post" id="freezeTRD" commandName="freezeTRD"> 	
	...
	<div id="divExistingFreezedVillageDeatils" class="form_stylings" style="display: none;">
		<div class="form_block">
				<div class="col_1">
					<h4>${freezeTRD.districtNameEnglish} district can't be freeze because below Local Bodies are in ${headingMessage}.In order to Freeze this district first take action on below Local bodies.</h4>
					<ul class="form_body">
						<li>
