...
function getFreezeLocalbodybyState(){
	...
	if(validateForm()){
		lgdDwrStateDistrictFreezeService.getFreezeLocalbodybyStatePopulation(parseInt(0),parseInt(res[0]),parseInt(res[2]),parseInt(0),callBackData);
	}else{
		$("#tableId").hide();
		$("#save").hide();
		...
		<body>
			<section class="content">
				<div class="row">
					...
					<!-- <div class="header">
						<h3>Local Body Population for Traditional</h3>
					</div> -->
						<div class="box">
							<form class="form-horizontal">
								<div class="box-header with-border">
									<h3 class="box-title"><spring:message text="Local Body Population For Traditional" code="" htmlEscape="true"></spring:message></h3>
								</div><!-- /.box-header -->
									...
									<table id="subdistrict" class="data_grid" cellspacing="0" style="width: 95%; margin-left: 3%;">
										<thead>
											<tr>
												...
												<th style="width: 40%;text-align: center;">Local Body Coverage</th>
												<th style="width: 10%;text-align: center;">Population</th>
											</tr>
										</thead>
										<tbody>
