...
<section class="content">
	<div class="row">
		...
		<div class="box">
		      <div class="box-header with-border">
		        <h3 class="box-title"><spring:message code="Label.freeze.trdLocalBodyFreeze" htmlEscape="true"></spring:message></h3>
		  </div><!-- /.box-header -->


		<%-- 	<div class="box-header subheading">
                  		<h4 class="box-title"><spring:message code="Label.freeze.trdLocalBodyFreeze"/></h4>
           </div><!-- /.box-header --> --%>

	
					<form:form action="freezeDistrictTRD.htm" method="post" id="freezeTRD" commandName="freezeTRD" class="form-horizontal"> 	
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="freezeDistrictTRD.htm"/>"/>
				
				<div class="box-body">
				<form:hidden path="processAction"/>
				<form:hidden path="lbLRType" value="T"/>	
	...
	<div id="divExistingFreezedVillageDeatils" class="form_stylings" style="display: none;">
		<div class="form_block">
				<div class="col_1">
					<h4><c:out value="${freezeTRD.districtNameEnglish} district can't be freeze because below Local Bodies are in ${headingMessage}.In order to Freeze this district first take action on below Local bodies." ></c:out> </h4>
					<ul class="form_body">
						<li>
...
$(window).load(function () {
	...
	customAlert("Traditional LocalBody has been  already  Freezed by State User. You can't UnFreezed.");
</c:if>
}); 
</script>
