			...
			<section class="col-lg-12">
				<div class="box">
					...
					<form:form action="allStateFreeze.htm" id="allStateFreezeid" commandName="stateFreeze" method="post" class="form-horizontal">
					    ...
					    <input type="hidden" id="userid" name="userid" value="<c:out value='${userid}' escapeXml='true'></c:out>"></input>
					    <input type="hidden" id="dcpdesValues" name="dcodes" value=""></input>
					    <input type="hidden" id="statusByStateUser" name="statusByStateUser" value=""></input>
						    ...
						    <div class="modal-dialog">
						      ...
						      <div class="modal-content">
						        <div class="modal-header">
						          ...
						          <h4 class="modal-title"><spring:message code="Msg.LocalBodyPendingInDraft"  htmlEscape="true"></spring:message></h4>
						        </div>
						        <div class="modal-body">
						           <table id="tblSample" class="table table-bordered table-striped dataTable no-footer" width="80%" cellspacing="0">
							           	<thead>
							           		<tr>
						        ...
						        <div class="modal-footer">
						          <button type="button" class="btn btn-danger" onclick="modelClose();"  data-dismiss="modal">Close</button>
						        </div>
						      </div>
					    ...
					    <div class="box-header subheading">
		                  <h4><spring:message code="Label.districtWiseFreezeunfreezeTrd" htmlEscape="true"></spring:message></h4>
		                </div>
		                <div class="box-body">
