...
<body oncontextmenu="return false"
 ...
 --%>					</a>
		...
		<div class="frmpnlbrdr">
			<form:form action="globalviewlocalbody.do" id="form1" method="POST"
				commandName="localbodybean">
				<input type="hidden" name="<csrf:token-name/>"
					value="<csrf:token-value uri="globalviewlocalbody.do"/>" />
						...
						<div class="frmtxt" align="center">
							<div class="frmhdtitle">
								<spring:message htmlEscape="true"
									code="Label.FILTEROPTFORVIEWLOCAL"></spring:message>
							</div>
										...
										<table width="900" height="21" class="tbl_no_brdr">
											<tr>
												<td class="tblclear"><label> <form:radiobutton
															path="correctionRadio" id='chkcrlocalbody'
															onclick='toggledisplay3("chkcrlocalbody","showbytext");doRefresh();' />
												</label></td>
												<td width="200" class="lblBold"><label><spring:message
															htmlEscape="true" code="Label.SEARCHBYNAME"></spring:message>
												</label>
												</td>
												<td>&nbsp;&nbsp;</td>
												<td class="tblclear" style="visibility: hidden"><label>
														<form:radiobutton path="correctionRadio"
															id='chkchlocalbody'
															onclick='toggledisplay3("chkchlocalbody","showbydropdown");doRefresh();' />
												</label></td>
												<td width="400" class="lblBold" style="visibility: hidden"><label><spring:message
															htmlEscape="true" code="Label.SEARCHBYHIERARCHY"></spring:message>
												</label>
												</td>
												<!-- <td>&nbsp;&nbsp;</td> -->
												<!-- correctly aligned no. of records label 22/05/2012 -->
												<td colspan="5" class="lblBold" align="right"><label>
														<spring:message htmlEscape="true"
															code="Label.NOOFRECORDPERPAGE"></spring:message> <form:select
															htmlEscape="true" path="pageRows" class="combofield"
															style="width: 50px">
				...
				<div class="frmpnlbg" id='showbytext'
					...
					<div class="frmtxt" align="center">
						...
						<table width="620" class="tbl_no_brdr">
							<tr>
								<td width="140" class="lblBold" align="center"><label><spring:message
								...
								<td><label><form:input type="text" class="frmfield"
											...
											path="code" /> </label> <form:errors htmlEscape="true" path="code"
										class="errormsg"></form:errors>
								</td>
								<td width="300" align="center" class="lblBold"><label><spring:message
											htmlEscape="true" code="Label.LOCALBODYNAMEINENG"></spring:message>
								</label>
								</td>
								<td><label><form:input type="text" class="frmfield"
											id="text2" onkeypress="validateCharKeys(event)"
											path="localBodyNameEnglish" /> </label> <form:errors htmlEscape="true"
										path="localBodyNameEnglish" class="errormsg"></form:errors>
								</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
							...
							<tr>
								<td height="50" colspan="4" align="center"><label>
										...
										onclick="javascript:location.href='login.do?<csrf:token uri='login.do'/>';" />
								</label>
								</td>
							</tr>
						</table>
						...
						<table width="580" class="tbl_no_brdr">
							<tr>
								...
								<td width="86%" class="lblBold" align="left"><label><spring:message
											htmlEscape="true" code="Label.SELECTSTATE"></spring:message>
								</label><br /> <form:select path="stateNameEnglish" class="combofield"
							...
							<tr>
								<td height="50" colspan="4" align="left"><label> <input
										type="button" name="Submit" class="btn" onclick="validate(1);"
										value='<spring:message htmlEscape="true"  code="Button.GETDATA"></spring:message>' />
								</label><label> <input type="button" name="Submit2" class="btn"
										value='<spring:message htmlEscape="true"  code="Button.CLEAR"></spring:message>'
									...
									<td width="14%" align="center">
										<table class="tbl_with_brdr" width="98%" align="center">
											<tr class="tblRowTitle tblclear">
												...
												<td width="21%" rowspan="2"><spring:message
														htmlEscape="true" code="Label.LOCALBODYNAMEINLOCAL"></spring:message>
												</td>
											...
											<tr class="tblRowTitle tblclear">
												...
												<td width="6%" align="center"><spring:message
														htmlEscape="true" code="Label.CORRECTION"></spring:message>
												</td>
												<td width="6%" align="center"><spring:message
														htmlEscape="true" code="Label.CHANGE"></spring:message>
												</td>
											</tr>
											<%-- <c:forEach var="stateWiseEntityDetails"
												varStatus="listVillageRow"
												items="${SEARCH_DISTRICT_RESULTS_KEY}">
												<tr class="tblRowB">
													<td width="6%">${offsets*limits+(listVillageRow.index+1)}</td>
													<td><c:out
															value="${stateWiseEntityDetails.villageCode}"></c:out>
													</td>
													<td align="left"><c:out
															value="${stateWiseEntityDetails.villageNameEnglish}"></c:out>
													</td>
													<td align="left"><c:out
															value="${stateWiseEntityDetails.villageNameLocal}"></c:out>
													</td>

													<td align="center"><a
														href="globalviewDistrictDetail.do?id=${stateWiseEntityDetails.villageCode}&<csrf:token uri="globalviewDistrictDetail.do"/>"><img
