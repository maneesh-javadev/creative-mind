	...
	<div class="row">
		...
		<div class="box">
		      <div class="box-header with-border">
		        <h3 class="box-title"><spring:message code="Label.freeze.priLocalBodyFreeze" htmlEscape="true"></spring:message></h3>
		  </div><!-- /.box-header -->
			...
			<%-- <div class="box-header subheading">
				...
				<form:form action="freezeDistrictPRI.htm" method="post" id="freezePRI" commandName="freezePRI" class="form-horizontal"> 	
