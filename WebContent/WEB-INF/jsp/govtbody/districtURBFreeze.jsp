...
<body>
	...
	<div class="form_stylings">
		...
		<!-- Main Heading starts -->
		<div class="header">
			<h3><spring:message code="Label.freeze.urbiLocalBodyFreeze"/></h3>
			<ul class="item_list">
		...
		<div class="page_content">
			<div class="form_container">
				<form:form action="freezeDistrictURB.htm" method="post" id="freezeURB" commandName="freezeURB"> 	
	...
	<div id="divExistingFreezedVillageDeatils" class="form_stylings" style="display: none;">
		<div class="form_block">
				<div class="col_1">
					<h4>${freezeURB.districtNameEnglish} district can't be freeze because below Local Bodies are in ${headingMessage}.In order to Freeze this district first take action on below Local Bodies.</h4>
					<ul class="form_body">
						<li>
