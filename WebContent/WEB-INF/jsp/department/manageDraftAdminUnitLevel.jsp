...
<body>
	<div id="frmcontent">
		...
		<div class="frmhd">
			<h3 class="subtitle">
				<spring:message code="Label.MANAGEDRAFTUNIT" htmlEscape="true" text="Manage Draft Unit Levels"></spring:message>
			</h3>
											...
											<tbody>
												<c:forEach var="adminUnitLevelDetail" varStatus="listAdminRow" items="${DEPT_ADMIN_LEVEL}">
													<tr class="tblRowB">
														...
														<td width="8%" style="text-align: center"><a href="#"><img src="images/edit_icon.png" onclick="javascript:manageAdminUnit('view_modifyDeptAdmitUnitDraft.htm',${adminUnitLevelDetail.adminUnitCode});" width="18" height="19"
																border="0" /></a></td>
														<td width="8%" style="text-align: center"><a href="#"><img src="images/publish.png" onclick="javascript:manageAdminUnit('publish_AdminLevelDetailDraft.htm',${adminUnitLevelDetail.adminUnitCode});" width="18" height="19"
																border="0" /></a></td>
														<td width="8%" style="text-align: center"><a href="#"><img src="images/delete.png" onclick="javascript:manageAdminUnit('deleteDeptAdmitUnitDraft',${adminUnitLevelDetail.adminUnitCode});" width="18" height="19" border="0" /></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
