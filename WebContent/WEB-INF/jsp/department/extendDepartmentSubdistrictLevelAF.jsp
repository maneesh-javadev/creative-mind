...
<script type='text/javascript' src='<%=contextPath%>/dwr/call/plaincall/lgdDwrSubDistrictService.getSubDistrictListbyDistrictCodewithDistrictNameExtend.dwr'></script>
...
function validation(){
	...
	if(itr==0 && document.getElementById('rdSpecificDistrictSub').checked){
		...
		if(check1==false && check2==false)
			{
			document.getElementById('errorddTargetDistrict').innerHTML="Kindly select District from the list .";
			document.getElementById('errorddTargetDistrictSDLvl').innerHTML="OR<br>Kindly select Sub District from the list.";
			flag=false;
			}
	}
	return flag;
...
function toggle2(){
	...
	document.getElementById('divspecificSubDistrict').style.display='none';
	if(obj1.checked){
		dwr.util.removeAllOptions('dddistrictAtStateLvl');
		dwr.util.removeAllOptions('ddTargetDistrict');
		document.getElementById("dddistrictAtStateLvl").disabled=false;
		 document.getElementById("moveLeft").disabled=false; 
		 document.getElementById("moveRight").disabled=false; 
		getdistrictListAtStatelvlListBoxforExtend(document.getElementById('stateName')[document.getElementById('stateName').selectedIndex].value,document.getElementById('orgCode').value,'','');
	}
	if(!obj1.checked){
		document.getElementById('TblDFull').style.display='none';
		obj2.checked=false;
...
function toggle3(){
	...
	if(obj1.checked){
	/* 	if(selObj1.value>0){ */
		document.getElementById("dddistrictAtStateLvl").disabled=true;
		 document.getElementById("moveLeft").disabled=true; 
		 document.getElementById("moveRight").disabled=true; 
		dwr.util.removeAllOptions('dddistrictAtSDLvl');	
		dwr.util.removeAllOptions('ddSubdistrictAtSubDistrictLvl');	
		dwr.util.removeAllOptions('ddTargetDistrictSDLvl');	
		getNotInDistrictListExtend(document.getElementById('stateNameDistforSD')[document.getElementById('stateNameDistforSD').selectedIndex].value,'T');
...
function toogle4()
{
	getdistrictListAtStatelvlListBoxforExtend(document.getElementById('stateName')[document.getElementById('stateName').selectedIndex].value,document.getElementById('orgCode').value,document.getElementById('ddSubdistrictAtSubDistrictLvl')[document.getElementById('ddSubdistrictAtSubDistrictLvl').selectedIndex].value);	
	}
	
function toogle5()
{
	getdistrictListAtStatelvlListBoxforExtend(document.getElementById('stateName')[document.getElementById('stateName').selectedIndex].value,document.getElementById('orgCode').value,document.getElementById('ddTargetDistrictSDLvl')[document.getElementById('ddTargetDistrictSDLvl').selectedIndex].value,document.getElementById('ddTargetDistrictSDLvl').value);	
	}
</script>
</head>
<body >
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="extendDepartmentSubdistrictLevel.htm?level=${level}" method="POST" commandName="extendDepartment">
			<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="extendDepartmentSubdistrictLevel.htm"/>"/>
			<form:input path="levelNew" type="hidden" />
			<form:input path="orgCode" type="hidden" id="orgCode" value="${olc}"/>
				<div id="cat">
					<div class="frmpnlbg">
						<table width="100%" class="tbl_no_brdr">
							<tr>
								<td width="100%">
									...
									<div class="frmtxt">
										...
										<table width="100%" class="tbl_no_brdr">
											...
											<tr>
												<td width="14%"></td>
												<td width="30%"><spring:message htmlEscape="true"  code="Label.DEPTNAMESD"></spring:message>
													...
													<br /><form:input path="deptName" id="deptName" maxlength="200" style="width: 200px" onBlur="checkExistDepartment(${stateCode},'T',this.value)" class="frmfield"></form:input>
													</c:if>
									...
									<div class="frmtxt" id="divSubdistrictlvl">
										...
										<table width="100%" class="tbl_no_brdr">
											<tr>
												...
												<form:radiobutton
														path="levelradio" id="rdAllDistrictSub" htmlEscape="true" checked="true"
														onclick="toggle1();" value="F" /> <spring:message htmlEscape="true" 
														code="Label.ALLSUBDISTRICTSTATE"></spring:message> 
														&nbsp;&nbsp;&nbsp;&nbsp;
														
														<form:radiobutton
														path="levelradio" value="S" id="rdSpecificDistrictSub"  disabled="true" 
														onclick="toggle1();" /> <spring:message htmlEscape="true" 
														code="Label.SPECIFICSUBDISTRICT"></spring:message>
														</c:if>
														...
														<form:radiobutton
														path="levelradio" value="S" id="rdSpecificDistrictSub" checked="true" disabled="true" 
														onclick="toggle1();" /> <spring:message htmlEscape="true" 
														code="Label.SPECIFICSUBDISTRICT"></spring:message>
														</c:if>
													...
													<div class="frmtxt" id="divSpecificDistSub">
														...
														<table width="100%" class="tbl_no_brdr">
															...
															<tr>
																...
																<td width="100" align="center"><input type="button" id="moveLeft"
															...
															<tr>
																<td align="center"><input type="button" id="moveRight"
														...
														<tr id="tr_SubDistrict" >
																<tr>
																	<td colspan="3">
																			...
																			<table width="100%" class="tbl_no_brdr" align="left">
																				...
																				<spring:message htmlEscape="true"  code="Label.SELECTSTATE"></spring:message><br/>
																					<form:select path="" class="combofield" id="stateNameDistforSD" htmlEscape="true"
																						onchange="getNotInDistrictListExtend(this.value);">
																					<form:options items="${stateList}"
																					itemValue="stateCode"
																					itemLabel="stateNameEnglish"></form:options>
																					</form:select>
																		...
																		style="width:200px"
																		onchange="getSubdistrictAtSubDistrictlvlExtend(this.value);">
															...
															<tr>
																...
																<td width="100" align="center"><input type="button"
																	class="btn" value=" &gt;&gt;" style="width: 40px"
																	onClick="toogle4();listbox_moveacross('ddSubdistrictAtSubDistrictLvl', 'ddTargetDistrictSDLvl');" />
																</td>
															...
															<tr>
																<td align="center"><input type="button"
																	value=" &lt;&lt;" class="btn" style="width: 40px"
																	onClick="toogle5();listbox_moveacross('ddTargetDistrictSDLvl', 'ddSubdistrictAtSubDistrictLvl');" />
																</td>
															</tr>
														</table>
														<tr>
