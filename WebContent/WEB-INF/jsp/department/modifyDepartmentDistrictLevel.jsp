...
function checkTargetStatebox()
{
	//alert(document.getElementById('ddTargetState').length);
	if (document.getElementById('ddTargetState').length>0)
		document.getElementById('DistrictChkPart').checked='checked';
	 else
		document.getElementById('DistrictChkFull').checked='checked';
	}
function checkTargetState()	
{
	...
	if (document.getElementById('ddTargetState').length>0){
		...
		document.getElementById('rdSpecificStateDis').checked='checked';
		checkTargetStatebox();
		}
	else
		document.getElementById('rdAllStateDis').checked='checked';
...
function validation(){
	...
	if(itr==0 && document.getElementById('rdSpecificStateDis').checked){
		if(!document.getElementById('DistrictChkFull').checked && !document.getElementById('DistrictChkPart').checked){
			error=1;
			itr=1;
			alert("Kindly select either of the specific detail.");
		}
...
<body onload="onLoadSelect()">
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="modifyDepartmentDistrictLevel.htm?type=${level2}" method="POST" commandName="modifyDepartmentCmd">
				<div id="cat">
					<div class="frmpnlbg">
						<table width="100%" class="tbl_no_brdr">
							<tr>
										...
										<table width="100%" class="tbl_no_brdr">
											<tr>
												...
												<td width="34%" class="tblclear"><form:radiobutton
														...
														&nbsp;&nbsp;&nbsp;&nbsp;
														<form:radiobutton
														path="levelradio" value="S" id="rdSpecificStateDis" htmlEscape="true"
												...
												<td width="100%" colspan="3">
													<div class="frmtxt" id="divSpecificStateDist">
														...
														<table width="100%" class="tbl_no_brdr">
															<tr>
																<td width="14%"></td>
																<td><form:checkbox  name="checkbox" id="DistrictChkFull" value="Full" path="specificLevel" 
																onclick="DistrictFullPart();" />
																<spring:message htmlEscape="true"  code="Label.STATEFULLCOVERAGE"></spring:message></td>
																<td><form:checkbox  name="checkbox" id="DistrictChkPart" value="Part" path="specificLevel" 
																onclick="DistrictFullPart();" />
															...
															<tr>
																<td width="275" rowspan="4" align="center">
															...
															<tr>
																...
																<td width="275" rowspan="4" align="center"><spring:message htmlEscape="true" 
																		...
																		style="height:100px; width: 233px" class="frmtxtarea">
																		<form:options items="${districtList2}" 
																			itemValue="districtPK.districtCode"
																			itemLabel="districtNameEnglish"></form:options></form:select>
																</td>
															</tr>
