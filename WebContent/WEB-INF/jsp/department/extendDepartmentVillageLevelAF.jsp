...
<body onload="onLoadSelect()">
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="extendDepartmentVillageLevel.htm?level=${level}" method="POST" commandName="extendDepartment">
			<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="extendDepartmentVillageLevel.htm"/>"/>
										...
										<table width="100%" class="tbl_no_brdr">
											...
											<tr>
												...
												<td width="30%"><spring:message htmlEscape="true"  code="Label.DEPTNAMEV"></spring:message>
													...
													<br /><form:input path="deptName" id="deptName" maxlength="200" style="width: 200px" onBlur="checkExistDepartment(${stateCode},'V',this.value)" class="frmfield"></form:input>
													</c:if>
												</td>
										...
										<table width="100%" class="tbl_no_brdr">
											<tr>
												...
												<td width="36%" class="tblclear">
													...
													<form:radiobutton
														path="levelradio" id="rdAllVillages" htmlEscape="true" checked="true"
														onclick="toggle1();" value="F" /> <spring:message htmlEscape="true" 
														code="Label.ALLVILLAGESTATE"></spring:message> 
														&nbsp;&nbsp;&nbsp;&nbsp;
														
														<form:radiobutton
														path="levelradio" value="S" id="rdSpecificVillages" disabled="true" 
														onclick="toggle1();" /> <spring:message htmlEscape="true" 
														code="Label.SPECIFICVILLAGE"></spring:message>
													</c:if>
													...
													<form:radiobutton
														...
														<form:radiobutton
														path="levelradio" value="S" id="rdSpecificVillages" disabled="true"  checked="true"
														onclick="toggle1();" /> <spring:message htmlEscape="true" 
														code="Label.SPECIFICVILLAGE"></spring:message>
													</c:if>
													...
													<div class="frmtxt" id="divSpecificVillage">
														...
														<table width="100%" class="tbl_no_brdr">
															...
															<tr>
																...
																<td width="200" rowspan="3" align="center"><spring:message htmlEscape="true" 
																		code="Label.SUBDISTRICTLISTSELECTED"></spring:message><br /> <form:select
