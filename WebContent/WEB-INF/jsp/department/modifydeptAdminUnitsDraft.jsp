...
<body >
	<div id="frmcontent">
		...
		<h3 class="subtitle"><spring:message code="Label.ModifyAdminUnitDraft" htmlEscape="true"	text="Modify Draft Administrative Unit Level"></spring:message></h3>
		...
		<!-- <div class="clear"> -->
			<div class="frmpnlbrdr">
				<form:form action="modifyDeptAdmitUnit.htm" method="POST"
					id="form1" commandName="deptAdminUnit">
					<input type="hidden" name="<csrf:token-name/>"
						value="<csrf:token-value uri="modifyDeptAdmitUnitDraft	.htm"/>" />
					<input type="hidden" name="stateCode" id="stateCode"
						value="${stateCode}" />
						<form:hidden htmlEscape="true" path="buttonClicked"
								value="" />	
					...
					<div id="cat">
						<div class="frmpnlbg">
							<div class="frmtxt">
								<div class="frmhdtitle">
									<spring:message code="Label.GenDetailAdminUnitsDraft" htmlEscape="true"
										text="General Details of Draft Admin Unit Level"></spring:message>
								</div>
								...
								<div >
									<ul class="blocklist">
										<li>
											...
											class="errormsg">*</span><br />  <form:input
												...
												style="width: 150px" value="${deptAdminUnitForm.adminLevelNameEnglish }" maxlength="100"/>
												<div class="errormsg">
										...
										<li>
											...
											<br />  <form:input path="adminLevelNameLocal"
												...
												htmlEscape="true" class="frmfield" style="width: 150px" value="${deptAdminUnitForm.adminLevelNameLocal }" maxlength="100"/>
                                       ...
                                       <div class="errormsg">
										...
										<li>
													...
													text="Select Parent Administrative Unit Level" htmlEscape="true"></spring:message></label><span
											class="errormsg">*</span><br />  <label> <form:select
													htmlEscape="true" path="parentAdminCode" class="combofield"
													id="parentUnit" onclick="clearDivs()" style="width: 150px">
													<form:option value="0">
									...
									<li><label> <spring:message  text=" Is  covered area of the Admin Unit entities is overlapping or not"
										...
										<ul class="listing">
											...
											</label><spring:message code="Label.YES"/> <label> <form:radiobutton id="overlapUnitno" path="overlapUnit" htmlEscape="true" value="N"  />
						...
						<div id="dialog-confirm" title="Administrative Units ?"
							...
							<p>
								...
								confirmed to Modify Draft Admin Unit ?
							</p>
						</div>

						<div class="btnpnl">

							<label> <input type="button" class="bttn" name="Submit"
												onclick="ValidateAndSubmitforupdateForDraft()" id="submit1"
												value="<spring:message code="Button.SAVE" htmlEscape="true"></spring:message>" />
											</label>
											
											<label> <input type="button" class="bttn" name="Publish"
												onclick="ValidateAndSubmitforupdateForDraftPublish()" id="submit1"
												value="<spring:message code="Label.PUBLISH" htmlEscape="true"></spring:message>" />
											</label>
											
											<label><input type="button" class="bttn"
												id="Submit6" value="<spring:message code="Button.CLEAR"></spring:message>"
												onclick="emptymodifyElements()" /></label>
											 <label><input type="button" name="Submit6" class="bttn"
