...
function validation(){
	...
	if(itr==0 && document.getElementById('deptName').value==""){
		...
		document.getElementById('errordeptName').innerHTML="Kindly fill the block level unit name.";
		return false;
	}
	else
		{
	...
	if(itr==0 && document.getElementById('rdSpecificDistrictSub').checked){
		...
		if(document.getElementById('DistrictChkPart').checked){
			...
			if(document.getElementById('ddTargetDistrictSDLvl').value==""){
				/* error=1; */
				/* itr=1;
				/* alert("Kindly select Block from the list."); */
				/* document.getElementById('errorddTargetDistrictSDLvl').innerHTML="Kindly select Block from the list.";
				flag=false; */ 
				check2=false;
			}
		}
		...
		{
		document.getElementById('errorddTargetDistrict').innerHTML="Kindly select District from the list .";
		document.getElementById('errorddTargetDistrictSDLvl').innerHTML="OR<br>Kindly select Block from the list. ";
		flag=false;
		}
	}
	return flag;
...
function toggle2(){
	...
	if(obj1.checked){
		...
		getdistrictListAtStatelvlListBoxforExtendforBlock(document.getElementById('stateName')[document.getElementById('stateName').selectedIndex].value,document.getElementById('orgCode').value);
	}
	if(!obj1.checked){
		document.getElementById('TblDFull').style.display='none';
		obj2.checked=false;
...
function toggle3(){
	...
	if(obj1.checked){ 
		...
		getNotInDistrictListExtend(document.getElementById('stateNameDistforSD')[document.getElementById('stateNameDistforSD').selectedIndex].value,'B');
	...
	<div id="frmcontent">
		<div class="frmhd" >
			...
			<table width="100%" class="tbl_no_brdr">
				<tr>
					<td><spring:message htmlEscape="true"  code="Label.CREATEDEPTBLOCKLEVEL"></spring:message>
					</td>
		...
		<div class="frmpnlbrdr">
			<form:form action="extendDepartmentBlockLevel.htm?level=${level}" method="POST" commandName="extendDepartment">
			<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="extendDepartmentBlockLevel.htm"/>"/>
								...
								<td width="100%">
									<div class="frmtxt">
										...
										<table width="100%" class="tbl_no_brdr">
											...
											<tr>
												<td width="14%"></td>
												<td width="30%"><spring:message htmlEscape="true"  code="Label.DEPTNAMEB"></spring:message>
													<span class="errormsg">*</span> <c:if test="${setNew==false}">
													...
													<br /><form:input path="deptName" id="deptName" maxlength="200" onBlur="checkExistDepartment(${stateCode},'B',this.value)" style="width: 200px" class="frmfield"></form:input>
													</c:if>
												</td>
											...
											<tr>
												...
												<form:radiobutton
													...
													<form:radiobutton
														...
														<form:radiobutton
														path="levelradio" value="S" id="rdSpecificDistrictSub" disabled="true" checked="true"	
														onclick="toggle1();" /> <spring:message htmlEscape="true" 
														code="Label.SPECIFICBLOCK"></spring:message>
													</c:if>
														<c:if test="${setNew==true}">
													...
													<div class="frmtxt" id="divSpecificDistSub">
														...
														<tr id="tr_SubDistrict" >
																<tr>
																	<td colspan="3">
																		...
																		<div class="frmtxt" id="divspecificSubDistrict">
																			<table width="650">
																			<div class="frmhdtitle">
																				<spring:message htmlEscape="true"  code="Label.SPECIFICBLOCK"></spring:message>
																			</div>
																		...
																		style="width:200px"
																		onchange="getBlockListExtend(this.value);">
															...
															<tr>
																<td width="200" rowspan="3" align="center">
																<spring:message htmlEscape="true" 
																		code="Label.BLOCKLIST"></spring:message><br /> <form:select
																		path="" multiple="true"
																...
																<td width="200" rowspan="3" align="center"><spring:message htmlEscape="true" 
																		code="Label.BLOCKLISTSELECTED"></spring:message><br /> <form:select
																		path="BlockName" multiple="true" id="ddTargetDistrictSDLvl"
																		style="height:100px; width: 233px" class="frmtxtarea"/>
																</td>
