...
<body onload="onLoadSelect()">
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="createDepartmentBlockLevel.htm?level=${level}" method="POST" commandName="createDepartment">
			<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="createDepartmentBlockLevel.htm"/>"/>
				<div id="cat">
					<div class="frmpnlbg">
						<table width="100%" class="tbl_no_brdr">
							<tr>
								<td width="100%">
									<div class="frmtxt">
										...
										<table width="100%" class="tbl_no_brdr">
											...
											<tr>
												<td width="14%"></td>
												<td width="30%"><spring:message htmlEscape="true"  code="Label.BLOCKDEPTNAMEENG"></spring:message>
											...
											<tr>
												<td width="14%"></td>
												<td width="30%"><spring:message htmlEscape="true"  code="Label.BLOCKDEPTNAMELC"></spring:message>
										...
										<table width="100%" class="tbl_no_brdr">
											<tr>
												...
												<td width="36%" class="tblclear"><form:radiobutton
														...
														code="Label.SPECIFICBLOCK"></spring:message></td>
												<td width="50%"></td>
											</tr>
											<tr><td></br></td></tr>
											<tr>
													...
													<tr>
														...
														<label> 
																	<input 	type="button" 
																			...
																			id="btnCancel" 
																			onclick="javascript:location.href='createDepartmentBlockLevel.htm?level=${plevel}&<csrf:token uri='createDepartmentBlockLevel.htm'/>';" /> 
															</label>
