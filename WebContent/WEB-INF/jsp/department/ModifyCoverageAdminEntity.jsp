				...
				<div id="cat">
					<div class="frmpnlbg">
						<div class="frmtxt">
							...
							<ul class="blocklist">
								<li class="lblBold"><label> <spring:message code="Label.AdminUnitEntityEng" text="Administrative Unit Entity (In English)"></spring:message></label> <br /> <label> <c:out value="${departmentAdminForm.adminLevelNameEnglish}"
											escapeXml="true"></c:out></label> <br /></li>
								<li class="lblBold"><label> <spring:message code="Label.AdminUnitEntityLoc" text="Administrative Unit Entity (In Local)"></spring:message></label> <br /> <label> <c:out value="${departmentAdminForm.adminLevelNameLocal}"
											escapeXml="true"></c:out></label> <br /></li>
								<li></li>
								<li></li>
							</ul>
					...
					<div class="btnpnl">
						<div>
							<label> <input type="button" class="btn" name="Submit" onclick="ValSubmitChangeCoverageEntity()" id="submit1" value="<spring:message code="Button.SAVE" htmlEscape="true"></spring:message>" />
