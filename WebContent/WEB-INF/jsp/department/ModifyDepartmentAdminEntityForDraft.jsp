...
<body>
	<div id="frmcontent">
		<div class="frmhd">
			<h3 class="subtitle">
				<spring:message code="Label.ModifyAdminEntity" htmlEscape="true" text="Modify Administrative Unit Entity"></spring:message>
			</h3>
		...
		<div class="frmpnlbrdr">
			<form:form action="modifyDeptAdmitEntity.htm" method="POST" id="form1" commandName="deptAdminUnit">
				...
				<div id="cat">
							...
							<div>
								<ul class="blocklist">
									<li><label><spring:message code="Label.SELDeptAdministrationUNIT" text="Type of Administrative unit Level" htmlEscape="true"></spring:message></label><span class="errormsg">*</span><br /> <br /> <label> <form:select
												htmlEscape="true" path="adminUnitLevelCode" onchange="resetAdminParentIndex();getUnitLevelEntity();" class="combofield" id="unitLevelCode" style="width: 150px">
												<form:option value="0">
									...
									<li id="statePopup" style="display: none;"><label><spring:message code="Label.SELECTSTATE" htmlEscape="true"></spring:message></label> <span class="errormsg">*</span> <br /> <label> <select class="combofield"
											onchange="getUnitParentLvlEntity(this.value);" id="stateId" style="width: 150px">
												<option value="0">
									...
									<li><label><spring:message code="Label.SELDEPTPARENTUNITENTITY" text="Parent level Administrative Unit Entity" htmlEscape="true"></spring:message></label> <span class="errormsg">*</span> <br /> <br /> <label> <form:select
												htmlEscape="true" path="parentAdminUnitEntityCode" class="combofield" id="parentUnit" onchange="checkmodifyEntityName();" style="width: 150px">
										...
										<div id="parentAdminUnitforEntity" style="color: red;"></div></li>
									<li><label><spring:message code="Label.AdminUnitEntityEng" text="Administrative Unit Entity Name(In English)"></spring:message></label><span class="errormsg">*</span><br /> <br /> <form:input path="adminEntityNameEnglish"
											id="adminLevelNameEng" onblur="chekModifyNameValidatonsforEntity(this.value);" name="adminLevelNameEng" htmlEscape="true" class="frmfield" style="width: 150px" value="${deptAdminUnitForm.adminLevelNameEnglish }" maxlength="100" /> <br />
										<br />
										<div class="errormsg">
											<form:errors htmlEscape="true" path="adminEntityNameEnglish"></form:errors>
										</div>
										<div id="UniqueDeptAdminError" style="color: red;"></div></li>
									<li><label><spring:message code="Label.AdminUnitEntityLoc" text="Administrative Unit Entity Name (In Local)"></spring:message></label> <br /> <br /> <label> <form:input path="adminEntityNameLocal" id="adminLevelNameLocal"
												name="adminLevelNameLocal" htmlEscape="true" class="frmfield" style="width: 150px" value="${deptAdminUnitForm.adminLevelNameLocal }" maxlength="100" />
									</label> <br /> <br />

										<div class="errormsg">
											<form:errors htmlEscape="true" path="adminEntityNameLocal"></form:errors>
										</div></li>
									<li style="display: none"><label> <a href="#" style="text-decoration: underline; color: navy;" onclick="showReports();">View Affected Organization Units</a>
									</label></li>
									<li></li>
								</ul>
								<div class="clear"></div>
					...
					<div id="dialog-message" title="View Affected Organization Units" style="display: none;">
											...
											<table cellpadding="0" cellspacing="0" border="0"
												...
												<c:forEach var="fyearval" items="${adminEntityOrg}" varStatus="listAdminRow" >
													<c:forEach var="adminEntityDetail" varStatus="listAdminRow"
														...
														<tr class="tblRowB">
															<td align="center">${offsets*limits+(listAdminRow.index+1)}</td>
															<td align="left">
															<c:out value="${fyearval}"></c:out>
															<c:out
					...
					<div class="btnpnl">
						<div>
							<label><input type="button" class="btn" name="Submit" onclick="ValidateAndSubmitforEntityupdateForDraft()" id="submit1" value="<spring:message code="Button.SAVE" htmlEscape="true"></spring:message>" /></label> 
							<label><input type="button" class="btn" id="Submit6" value="<spring:message code="Button.CLEAR"></spring:message>" onclick="emptymodifyEntityElements()" /></label>
							<label><input type="button" name="Submit6" class="btn" value="<spring:message code="Button.CLOSE" htmlEscape="true"></spring:message>" onclick="javascript:location.href='home.htm?<csrf:token uri='home.htm'/>';" /></label>
						</div>
					</div>
				</div>
			</form:form>
