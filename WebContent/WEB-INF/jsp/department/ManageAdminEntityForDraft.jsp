			...
			<form:form action="view_AdminLevelDetail.htm" id="form1" method="POST" commandName="adminLevelBean">
				...
				<div id="selectEntityType">
					<div class="frmpnlbg">
						...
						<div class="btnpnl">
							<div>
								<label> <input type="button" class="btn" name="Submit" onclick="validateGetEntityByLevelForDraft()" id="submit1" value="<spring:message code="Button.PROCEED" htmlEscape="true"  ></spring:message>" />
											...
											<table cellpadding="0" cellspacing="0" border="0" class="display" id="modifyAdminUnitLevel">
												...
												<tbody>
													<c:forEach var="adminEntityDetail" varStatus="listAdminRow" items="${DEPT_ADMIN_LEVEL}">
														<tr class="tblRowB" id="${adminEntityDetail.adminUnitEntityCode}">
															...
															<td width="8%" align="right"><a href="#"><img src="images/publish.png" onclick="javascript:publishAdminEntity(${adminEntityDetail.adminUnitEntityCode});" width="18" height="19" border="0" /></a></td>
															<td align="center"><a href="#"><img src="images/edit.png" onclick="javascript:manageAdminUnit('view_modifyDeptAdmitEntityForDraft.htm',${adminEntityDetail.adminUnitEntityCode});" width="18" height="19" border="0" /></a></td>
															<td align="center"><a href="#"><img src="images/edit.png" onclick="javascript:manageAdminUnit('modifyAdminEntityCoverageForDraft.htm',${adminEntityDetail.adminUnitEntityCode});" width="18" height="19" border="0" /></a></td>
															<td width="8%" align="center"><a href="#"><img src="images/delete.png" onclick="javascript:validateEntityChildExistforDraft(${adminEntityDetail.adminUnitEntityCode});" width="18" height="19" border="0" /></a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
