...
<body onload="onLoadSelect()">
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="modifyDepartmentSubdistrictLevel.htm?type=${level2}" method="POST" commandName="modifyDepartmentCmd">
				<div id="cat">
					<div class="frmpnlbg">
						<table width="100%" class="tbl_no_brdr">
							<tr>
														...
														<tr id="tr_SubDistrict" >
															...
															<tr>
																...
																<spring:message htmlEscape="true" 
																		...
																		path="" multiple="true"
																		style="height:100px; width: 233px" class="frmtxtarea" id="ddSubdistrictAtSubDistrictLvl" htmlEscape="true">
																	</form:select></td>
																...
																<td width="275" rowspan="3" align="center"><spring:message htmlEscape="true" 
																		...
																		style="height:100px; width: 233px" class="frmtxtarea">
																		<form:options items="${subdistrictList2}" 
																			itemValue="subdistrictPK.subdistrictCode"
																			itemLabel="subdistrictNameEnglish"></form:options></form:select>
																</td>
															</tr>
