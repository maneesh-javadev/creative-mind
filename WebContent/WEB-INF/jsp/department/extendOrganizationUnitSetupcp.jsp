...
<!-------------- ------------------------------General Details started ------------------------------------------------->
    ...
    <c:if test="${not empty pageAccessLevel}">
	    <div class="form-group">
		  ...
		  <div class="col-sm-6">
		  	<form:input path="parentDepartmentName" value="" htmlEscape="true" disabled="true" class="form-control"/>
		 </div>
		</div>
	</c:if>
	<div class="form-group">
		  ...
		  <div class="col-sm-6">
		  	<form:input path="departmentNameEnglish" value="" htmlEscape="true" disabled="true" class="form-control"/>
		 </div>
	</div>
	<div class="form-group">
		  ...
		  <div class="col-sm-6">
		  	<form:input path="departmentNameLocal" value="" htmlEscape="true" disabled="true" class="form-control"/>
		 </div>
	</div>
	<div class="form-group">
		  ...
		  <div class="col-sm-6">
		  	<form:input path="departmentShortName" value="" htmlEscape="true" disabled="true" class="form-control"/>
		 </div>
	</div>
			    ...
			    <div class="modal-dialog">
			      ...
			      <div class="modal-content">
			        <div class="modal-header">
			          ...
			          <div id="title"><h4 class="modal-title"></h4></div>
			        </div>
