...
<body>
	<div id="frmcontent">
		<div class="frmhd">
				<h3 class="subtitle"><spring:message code="Label.NewAdminLevel" htmlEscape="true" ></spring:message></h3>
						...
						<div class="frmpnlbg">
							<div class="frmtxt">
								<div class="frmhdtitle">
									<spring:message code="Label.GenDetailAdminUnits" htmlEscape="true"
										text="General Details of Admin Unit "></spring:message>
								</div>
									...
									<ul class="blocklist" >
										<li>
											...
											class="errormsg">*</span><br /> <br /><form:input
												...
												onblur="chekNameValidatons(this.value);"
										...
										<li>
											...
											<br /> <br />  <form:input path="adminLevelNameLocal"
                                ...
                                <div class="errormsg">
										...
										<li>
											...
											<br /> <label> <form:select htmlEscape="true"
										...
										<form:errors htmlEscape="true" path="parentAdminCode"></form:errors>
										 ...
										 <li>
											<label> <spring:message  text="Is  covered area of the Admin Unit entities is overlapping or not" htmlEscape="true"></spring:message><span class="errormsg">*</span></label>
											<ul class="listing">
