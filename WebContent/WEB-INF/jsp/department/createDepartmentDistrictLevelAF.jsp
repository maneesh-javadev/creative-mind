										...
										<table width="100%" class="tbl_no_brdr">
											<tr>
												...
												<td width="34%" class="tblclear"><form:radiobutton
														...
														onclick="toggle();" value="F" /> <spring:message htmlEscape="true" 
											...
											<tr><td></br></td></tr>
															...
															<tr>
																...
																<td width="300"><div id="errorddTargetDistrict" class="errormsg"></div><form:errors htmlEscape="true"  path="districtName"
														cssClass="errormsg"></form:errors></td>
															</tr>
										...
										<input type="hidden" name="addAnother" id="addAnother"/>
											...
											<td width="84%" align="left"><label> <input
												...
												<input type="button" class="button"
													...
													id="btnCancel" onclick="javascript:location.href='createDepartmentDistrictLevel.htm?level=${level}&<csrf:token uri='createDepartmentDistrictLevel.htm'/>';" /> </label>
