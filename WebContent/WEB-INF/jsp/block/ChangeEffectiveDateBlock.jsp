...
<title><spring:message code="Label.CHANGE.EFFECTIVE.DATE.BLOCK" htmlEscape="true"></spring:message></title>
...
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/block/changeEffectiveDateController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/block/changeEffectiveDateChildController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/block/changeEffectiveDateService.js"></script>
<script  type="text/javascript" src="${pageContext.request.contextPath}/angularjs/ui-bootstrap-tpls-0.11.0.js"></script>
<script>
var _JS_BLOCK_CODE="${blcCode}";
...
<section class="content">
	<div class="row">
		...
		<div class="box-header subheading">
		    <h4><spring:message code="Label.CHANGE.EFFECTIVE.DATE" htmlEscape="true"></spring:message> of
		    	<spring:message code="Label.BLOCK" htmlEscape="true"></spring:message>
		    </h4>
			</div>
			...
			<table class="table table-bordered table-hover" width="80%">
    			 <tbody>
			      	<tr>
			      		<td width="30%"><spring:message htmlEscape="true" code="Label.BLOCKCODE"> : </spring:message></td>
					    <td width="50%">{{blockDetail.entityCode}}</td>
				   </tr>
		...
		<!-- <div style="height: 40px; border: 1px solid red; background-color: #FFEBE8; padding-top: 10px;" align="center">
			...
			<table class="table table-bordered table-hover" width="80%">
    			 ...
    			 <tr>
					   ...
					   <th width="10%" ><spring:message htmlEscape="true"	code="Label.BLOCKCODE"></spring:message></th>
					   <th  width="20%"><spring:message htmlEscape="true" code="Label.BLOCKNAMEINENGLISH"></spring:message></th>
					   <th width="5%"><spring:message htmlEscape="true" code="Label.BLOCKVER"></spring:message></th>
					   <th width="5%">Block Minor Version</th>
