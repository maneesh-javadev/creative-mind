...
<body>
	<div id="frmcontent">
		...
		<div class="frmpnlbrdr">
			<form:form action="unmapLBWardforPCACPOST.do" id="form1" name="form1" method="POST"
							...
							<div class="block">
								<ul class="blocklist">
									<li>
										...
										<form:select path="stateNameEnglish" class="combofield" id="ddSourceState" style="width:175px" onchange="error_remove();hideMessageOnKeyPressstate()" >
										<form:option value="">
				...
				<c:if test="${! empty StatewiseGPtoVillageMappingList}">
						...
						<h6 id="statusmessage" class="title" style="font-size:18px; font-weight:bold; text-align:center; margin:0;">
							...
							<tr class="tblRowTitle tblclear" bgcolor="#e21d63">
										...
										<td width="21%"><spring:message
												code="Label.TotalVL"></spring:message></td>
