...
<title>
Unmapped LocalBodies/Ward for PC/AC Report
</title>
...
<body>
	<div id="frmcontent">
		<div class="frmhd">
			<h3 class="subtitle"><spring:message htmlEscape="true" code="Label.unmappedLBWARDPCAC"></spring:message></h3>			
			...
			<div id="cat">
				...
				<c:if test="${! empty StatewiseGPtoVillageMappingList}">
						...
						<div id="printable">
							...
							<table class="gridtable" width="98%" align="center" id="tbl_with_brdr" >
							...
							<tr class="tblRowTitle tblclear" bgcolor="#e21d63">
										...
										<td width="15%" ><spring:message
												code="Label.WARDNAME"></spring:message>
										</td>
									...
									<c:forEach var="listStatewiseGPtoVillageMappingDetail" varStatus="listEntityRow" items="${StatewiseGPtoVillageMappingList}">
													<tr class="tblRowB">
														...
														<td><c:out value="${listStatewiseGPtoVillageMappingDetail.lbcode}" escapeXml="true"></c:out></td>
														<td align="left"><c:out value="${listStatewiseGPtoVillageMappingDetail.lbName}" escapeXml="true"></c:out></td>
														<td align="left"><c:out value="${listStatewiseGPtoVillageMappingDetail.lbtName}" escapeXml="true"></c:out></td>
														<td><c:out value="${listStatewiseGPtoVillageMappingDetail.wardCode}" escapeXml="true"></c:out></td>
														<td align="left"><c:out value="${listStatewiseGPtoVillageMappingDetail.wardName}" escapeXml="true"></c:out></td>
