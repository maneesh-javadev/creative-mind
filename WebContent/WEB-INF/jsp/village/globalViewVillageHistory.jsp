...
<body >
		<div id="frmcontent">
			<div class="frmhd">
					<h2 class="Subtitle"><spring:message htmlEscape="true"  code="Label.VILLAGEHISTORY" ></spring:message></h3>
								...
								<tr>
									<td width="" align="center">
										     <tr class="tblRowTitle tblclear">
												...
												<td width="20%" rowspan="2"><spring:message htmlEscape="true" code="Label.VILLAGECODE"></spring:message></td>
												<td width="20%" rowspan="2"><spring:message htmlEscape="true" code="Label.VILLAGEVERSION"></spring:message></td>
												<td width="40%" rowspan="2"><spring:message htmlEscape="true" code="Label.VILLAGENAMEINENGLISH"></spring:message></td>
												<td width="10%" rowspan="2"><spring:message htmlEscape="true" code="Label.GAZETTESTATUS"></spring:message></td>
											<%-- 	<td width="40%" rowspan="2"><spring:message htmlEscape="true" code="Label.DESCRIPTION" ></spring:message></td>
												<td width="50%" rowspan="2"><spring:message htmlEscape="true" code="Label.GOVERMENTORDER" text="Govt Order"></spring:message></td> --%>
								           </tr>
								<tr><td><br/></td></tr>
											 ...
											 <tr class="tblRowB">
												...
												<%-- <td align="left"><c:out value="${villageHistoryDetail.description}" escapeXml="true"></c:out></td>
												<td width="10%" align="center">
												
												<a href="#"><img
																			src="images/gvt.order.png"
																			onclick="javascript:checkFileExists('${villageHistoryDetail.fileLocation}','${villageHistoryDetail.timeStatmp}');"
																			width="18" height="19" border="0" alt="Village Details" />
												</a>
												</td> --%>
												<%-- <c:if test="${villageHistoryDetail.timeStatmp ne '' }">
												<td width="10%" align="center"><a href="fileToDownloads.do?fileLocation=${villageHistoryDetail.fileLocation}&timeStatmp=${villageHistoryDetail.timeStatmp}&<csrf:token uri='fileToDownloads.do'/>"><img src="images/gvt.order.png" name="viewAttachment"
													width="22" height="18" alt="View" border="0"/></a>
												</td>
												</c:if>
												<c:if test="${villageHistoryDetail.timeStatmp eq '' }">
