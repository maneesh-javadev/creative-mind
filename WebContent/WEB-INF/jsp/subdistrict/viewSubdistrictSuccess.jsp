		...
		<div id="frmcontent">
			 <div class="frmhd">
				    <table width="100%" class="tbl_no_brdr">
					      <tr>
						             <td><spring:message htmlEscape="true"  code="Label.VIEWSUBDISTRICT"></spring:message></td>
				   ...
				   <input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="viewSubdistrict.htm"/>"/>
					<div class="frmpnlbg" >
						...
						<table class="tbl_with_brdr" width="98%" >
								<tr><td colspan="4" class="tblRowTitle tblclear"><label>New Sub District Created</label></td></tr>
							   ...
							   <c:forEach var="newSD" varStatus="fullRow" items="${newSD}">
							    <tr class="tblRowB">
							    <td width="15%" ><c:out value="${newSD.subdistrictCode}" escapeXml="true"></c:out></td>
								<td width="15%"><c:out value="${newSD.subdistrictVersion}" escapeXml="true"></c:out></td>
								<td width="35%" ><c:out value="${newSD.subdistrictNameEnglish}" escapeXml="true"></c:out></td>
								<td width="35%" ><c:out value="${newSD.subdistrictNameLocal}" escapeXml="true"></c:out></td>
							  </tr>
							  </c:forEach>
						</table>
						</div>
						...
						<table class="tbl_with_brdr" width="98%">
						<tr><td colspan="4" class="tblRowTitle tblclear"><label><spring:message code="Label.CONTRIBUTINGSUBDISTRICT" htmlEscape="true"></spring:message></label></td></tr>
						      <tr class="tblRowTitle tblclear">
							   <td width="15%" ><spring:message htmlEscape="true"  code="Label.SUBDISTRICTCODE"></spring:message></td>
								<td width="15%" ><spring:message htmlEscape="true"  code="Label.SUBDISTRICTVERSION"></spring:message></td>
								<td width="35%""><spring:message htmlEscape="true"  code="Label.SUBDISTRICTNAMEENGLISH"></spring:message></td>
