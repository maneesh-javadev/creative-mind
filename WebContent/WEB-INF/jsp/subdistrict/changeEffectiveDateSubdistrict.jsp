...
<title><spring:message code="Label.CHANGE.EFFECTIVE.DATE.SUBDISTRICT" htmlEscape="true"></spring:message></title>
...
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/subdistrict/changeEffectiveDateController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/subdistrict/changeEffectiveDateChildController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/subdistrict/changeEffectiveDateService.js"></script>
<script  type="text/javascript" src="${pageContext.request.contextPath}/angularjs/ui-bootstrap-tpls-0.11.0.js"></script>
<script>
var _JS_lb_CODE="${SdCode}";
...
<section class="content">
	<div class="row" >
		...
		<div class="box-header subheading">
		    ...
		    <spring:message code="Label.SUBDISTRICT" htmlEscape="true"></spring:message>
		...
		<table class="table table-bordered table-hover" width="80%">
    			 <tbody>
			      	<tr>
			      		<td width="30%"><spring:message htmlEscape="true" code="Label.SUBDISTRICTCODE"> : </spring:message></td>
					    <td width="50%">{{SdDetail.entityCode}}</td>
				   </tr>
		...
		<table class="table table-bordered table-hover" width="80%">
    			 ...
    			 <tr>
					   ...
					   <th width="10%" ><spring:message htmlEscape="true"	code="Label.SUBDISTRICTCODE"></spring:message></th>
					   <th  width="20%"><spring:message htmlEscape="true" code="Label.SUBDISTRICTNAMEENGLISH"></spring:message></th>
					   <th width="5%">Sub-District  Version</th>
					   <th width="5%">Sub-District Minor Version</th>
	   ...
	   <div class="col-sm-offset-2 col-sm-10">
		...
		<button style="width: 80px;" type="button" name="Submit3" class="btn btn-danger" onclick="javascript:location.href='home.htm?<csrf:token uri='home.htm'/>';"></i>  <spring:message code="Button.CLOSE" htmlEscape="true"></spring:message></button>
	   </div></div></div>
