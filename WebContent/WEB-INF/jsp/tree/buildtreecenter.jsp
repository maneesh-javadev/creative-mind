...
<head>
<%@ include file="buildtreecenterJs.jsp"%>
     ...
     <section class="col-lg-12">
		...
		<c:choose>
			<c:when  test="${!empty deptList }">
				<form:form commandName="extendDpet" action="buildTreeCenter.htm" method="POST" id="deptform" class="form-horizontal">
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="buildTreeCenter.htm"/>" />
				<br/><br/>
