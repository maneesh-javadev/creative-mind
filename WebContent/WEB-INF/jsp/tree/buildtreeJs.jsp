...
$(document).ready(function() {
	...
	var createBase=function(){
		 ...
		 buttonstate.setAttribute("class","btn btn-primary btn-xs");
		 buttonstate.setAttribute("type", "button");
		 buttonstate.setAttribute("onclick", "showchild('1')");
		 buttonstate.innerHTML ='State';
		 buttonstate.setAttribute('data-toggle', 'tooltip');
		 buttonstate.setAttribute("title", "Click to extend hierarchy at State Level ");
