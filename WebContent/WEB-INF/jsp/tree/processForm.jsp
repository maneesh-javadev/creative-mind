		      ...
		      <div class="box-header with-border">
				...
				<c:if test="${(empty pageAccessLevel and ( isCenterUser or isOrganizationFlow))}">
					...
					<div class="form-group">
							  ...
							  <div class="col-sm-6">
									<form:select path="orgType" id="orgType" cssClass="combofield">
										<form:option value="">
...
<c:if test="${isCenterUser == true}">
	<c:if test="${ fn:contains(pageAccessLevel, 'D')}">
		 <div class="form-group" id="tblStateList">
			  ...
			  <div class="col-sm-6">
				<form:select path="" class="combofield" id="stateName" onchange="getDistrictsforVillageS();"></form:select>
		      </div>
	   </div>
	</c:if>
</c:if>
	...
	<c:if test="${isCenterUser == true}">
		<c:if test="${ fn:contains(pageAccessLevel, 'T') or fn:contains(pageAccessLevel,'V')}">
			<div class="form-group" id="tblStateList1">
				  <label  class="col-sm-3 control-label" for="sel1"><spring:message htmlEscape="true" code="Label.SELECTSTATE" /></label>
				  <div class="col-sm-6">
					 <form:select path="" class="combofield" id="stateName1" onchange="getDistrictsforVillageS();"></form:select>
			      </div>
	   		</div>
		</c:if>
	</c:if>
...
<c:if test="${isCenterUser == true}">
	<c:if test="${ fn:contains(pageAccessLevel, 'T')  or fn:contains(pageAccessLevel, 'B')	or fn:contains(pageAccessLevel, 'V')}">
		<div class="form-group" id="tblDistrictSelectBox1">
				  ...
				  <div class="col-sm-6">
					 <form:select path="" class="combofield" id="stateNameDistforSD" style="width:200px" onchange="getNotInDistrictList(this.value);">
							<form:option value="">
 ...
 <div class="box-body dept_list_button" id="tblSubdistrictSpecific" >
		<div class="ms_container row"  >
			<div class="ms_selectable col-sm-5 form-group">
				...
				<form:select path="" id="ddSubdistrictAtSubDistrictLvl" multiple="true" class="frmtxtarea"></form:select>	
			</div>
			<div class="ms_buttons col-sm-2"><br>
	 ...
	 <div class="box-body dept_list_button" id="tblBlockSpecific" >
			<div class="ms_container row"  >
				<div class="ms_selectable col-sm-5 form-group">
					...
					<form:select path="" id="ddBlockAtDistrictLvl" multiple="true" class="frmtxtarea"></form:select>	
				</div>
				<div class="ms_buttons col-sm-2"><br>
...
<c:if test="${ fn:contains(pageAccessLevel, 'V')}">
	...
	<div class="form-group" id="tblDistrictSelectBox">
		  <label  class="col-sm-3 control-label" for="sel1"><spring:message htmlEscape="true" code="Label.SELECTSTATE" /></label>
		  <div class="col-sm-6">
			 <form:select path="" style="width:200px" class="combofield" id="stateNameSubDistForVillage" onchange="getNotInDistrictListVillLvl(this.value);">
					<form:option value="">
						<spring:message htmlEscape="true" code="Label.SELECT" />
					</form:option>
				</form:select>
	...
	<div id="tblDisttSubDisttVillLvlSelectBox">
		<div class="form-group" >
			  <label  class="col-sm-3 control-label" for="sel1"><spring:message htmlEscape="true" code="Label.SELECTDISTRICT" /></label>
			  <div class="col-sm-6">
				<form:select path="" id="dddistrictAtVillLvl" class="combofield" style="width:200px" onchange="getSubdistrictAtVilllvl(this.value)"></form:select>
		      </div>
		</div>	
		<div class="form-group" >
			  <label  class="col-sm-3 control-label" for="sel1"><spring:message htmlEscape="true" code="Label.SELECTSUBDISTRICT" /></label>
			  <div class="col-sm-6">
				<form:select path="" id="ddSubdistrictAtVillLvl" class="combofield" style="width:200px" onchange="getVillageListAtVillageLvl(this.value)"></form:select>
		      </div>
		</div>											
	</div>
	<div class="box-body dept_list_button" id="tblVillageSpecific" >
			<div class="ms_container row"  >
				<div class="ms_selectable col-sm-5 form-group">
					...
					<form:select path="" id="ddVillageAtVillLvl" multiple="true" class="frmtxtarea"></form:select>	
				</div>
				<div class="ms_buttons col-sm-2"><br>
