...
$(document).ready(function() {
    ...
    messages: { 
    	localBodyNameInEn: {
    		required: "<font color='red'><br><spring:message code='Error.URBANLBNEW' text='Please enter value'/></font>",
...
<body onsubmit="cursorwait();" oncontextmenu="return false" onkeypress="disableCtrlKeyCombination(event);" onkeydown="disableCtrlKeyCombination(event);" >
	...
	<div id="frmcontent">
		...
		<h3 class="subtitle"><label><spring:message code="Label.CONVERTRLBTOULB" htmlEscape="true"></spring:message></label></h3>
		...
		<div class="frmpnlbrdr">
			...
			<form:form commandName="convertRLBtoULB" action="draftConversionRLBtoULB.htm" method="POST" enctype="multipart/form-data" name="convertForm" id="convertForm">
				...
				<div id="cat">
					<div id="divFirstPanel" class="frmtxt">
							<div class="frmtxt">
								<div class="frmhdtitle">
									<spring:message code="Label.CONVERSIONRLB" htmlEscape="true"></spring:message>
								</div>
								...
								<form:hidden path="lbType" value="${convertRLBtoULB.lbType}" htmlEscape="true"></form:hidden>
													...
													<c:if test="${ddLevel.contains('D')}">
														<li>
															...
															<form:select
																	...
																	onblur="hideHelp();vlidateOnblur('ddDistrictPanchayat','1','15','c');"
													...
													<c:if test="${ddLevel.contains('DI') || ddLevel.contains('IV')}">
														...
														<label><spring:message code="Label.SELINTERMPANCHYAT" htmlEscape="true"></spring:message> </label>
															...
															<form:select
																	...
																	class="combofield"
																	onchange="getVillageLBforRLBULB(this.value)"
																	onfocus="validateOnFocus('ddIntermediateLb');helpMessage(this,'ddIntermediateLb_msg');"
																	onblur="hideHelp();vlidateOnblur('ddIntermediateLb','1','15','c');"
																	onkeyup="hideMessageOnKeyPress('ddIntermediateLb')">
	
																	<form:option value="0">
																		<spring:message code="Label.SELECT" htmlEscape="true"></spring:message>
																	</form:option>
																	<form:options items="${interPanchayatList}"
																		itemLabel="localBodyNameEnglish"
																		itemValue="localBodyCode" />
											...
											<ul class="blocklist">
															...
															<div class="ms_container">
																		...
																		<div class="ms_buttons">
																				<input	type="button" value="<spring:message code="Button.WHOLE"/>"	class="bttn" onclick="moveElementVP('FULL')" />

																		<input type="button" id="btnback" class="bttn"	name="Submit4"  value="Back &lt;"	onclick="moveElementVP('BACK')" />

																		<input type="button" value=" Reset &lt;&lt;" class="bttn"  onclick="moveElementVP('RESET')" />
																		<input type="button" value="Part &gt;&gt;" 	 class="bttn"  	onclick="moveElementVP('PART')" />
																	...
																	<span> <form:errors htmlEscape="true"
																		...
																		style="display: none;"> <spring:message
																				...
																				<input type="button" id="childbtn" value="<spring:message code="Button.GETCOVEREDAREAOFLOCALBODY" htmlEscape="true"/>" 	/>
									...
									<ul class="blocklist">
											<li>
													<div class="ms_container">
															<div class="ms_selectable">
																	...
																	<form:select id="ddSourceCoveredAreaRLB" path="localBodyLandRegionAreaSource" size="1" multiple="multiple" class="frmtxtarea" >
																	</form:select>
																	<span class="errormsg" id="errorddSourceCoveredAreaRLB"></span>
										...
										<div class="ms_buttons">
												<input type="button" class="bttn" id="btnAdd" value=" &gt;&gt;"  onclick="moveElement('FORWARD')" />
												<input type="button" class="bttn"	value=" &lt;&lt;" onclick="moveElement('BACK')" />
										</div>
															<div class="ms_selection">
														...
														<span id="errorddDestCoveredAreaRLB" class="errormsg"></span>										
															</div>																		
													</div>
							...
							<div class="btnpnl">
								<label> <input type="button" name="Submit" id="btnNext" onclick="return validateForm('R');" value="<spring:message code="Button.NEXTSTEP" htmlEscape="true"></spring:message>" /></label>
					...
					<div id="divSecondPanel" style="display: none">
						<div class="frmpnlbg">
							<div class="frmtxt">
								...
								<ul class="blocklist">
										<li>
												<form:radiobutton path="mergeRLBtoULB" htmlEscape="true"	id="rdmergeRLBtoULB" value="M"
																	onclick="radioClick(this.value);" /> &nbsp; <spring:message code="Label.MERGERLBTOULB" htmlEscape="true"></spring:message> <br /> 
												<form:radiobutton path="declarenewULB" id="rddeclarenewULB" onclick="radioClick(this.value);" value="N" htmlEscape="true"/> &nbsp; <spring:message
							...
							<div class="frmtxt">
								...
								<div  >
										<ul class="blocklist">
											...
											<form:select id="ddUrbanLocalBodyType" path="urbanLgTypeName" size="1" class="combofield"  onchange="getUrbanLocalBodies(this.value)">
											...
											<form:select id="ddUrbanLocalBody" path="urbanlocalBodyNameEnglish" size="1" class="combofield" onchange="askForUpgrade(this);">
												<form:option value="0">
													<spring:message code="Label.SELURBANLOCALBODY" htmlEscape="true"></spring:message>
												</form:option>
											</form:select>
										...
										<br />
											<form:select id="ddUrbanLocalBodyTypeForUpgrade" path="urbanLgTypeName" size="1" class="combofield"  disabled="true">
												<form:option value="0"><spring:message code="Label.SELECTLOCALBODYTYPE" htmlEscape="true"></spring:message></form:option>
												<form:options items="${urbanlbType}" itemLabel="localBodyTypeName" itemValue="localBodyTypeCode" />
											</form:select>
								...
								<div >
									<ul class="blocklist">
										...
										<li>
											...
											<spring:message
												code="Label.LOCALBODYALIASENGLISH" htmlEscape="true"></spring:message><br />
										...
										<li>
												...
												code="Label.SELURBANTYPEBODY" htmlEscape="true"></spring:message><span
											class="errormsg">*</span><br /> <form:select
												id="ddUrbanLocalBodyTypeNew" path="urbanLgTypeNameNew"
												...
												<form:options items="${urbanlbType}"
						...
						<div class="btnpnl" id="divSaveButtons">
							...
							<input type="button" value="<spring:message code="Button.PREVIOUS" htmlEscape="true"></spring:message>"
				 ...
				 <div id="dialog-commune" title="ALERT" style="display: none">
									<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Do You Want to convert the whole Commune Panchayat as ULB ?</p>
								</div>
