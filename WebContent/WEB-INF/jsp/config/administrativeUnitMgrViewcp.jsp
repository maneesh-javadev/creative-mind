...
<script type="text/javascript" language="javascript">
	function submitForm() {
		document.getElementById('form').action = "administrativeUnitMgrModify.htm";
...
<section class="content">
              <div class="row">
                   <section class="col-lg-12">
                       <div class="box">
               <form:form action="administrativeUnitMgrModify.htm" method="GET" id="form" commandName="configGovtOrderForm" >
     	          <input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="administrativeUnitMgrModify.htm"/>"/>
                    ...
                    <table class="table table-bordered table-hover">
                        <tr>
						  ...
						  <th  align="center"><spring:message htmlEscape="true" code="Label.OPTIONS"></spring:message></th>
						</tr>
					<tbody>
              ...
              <div class="box-footer">  
                <div class="col-sm-offset-2 col-sm-10">
	                 <div class="pull-right">                   
			              <button type="button" onclick="submitForm()" id="btnModify" class="btn btn-success" name="Submit"  ><spring:message htmlEscape="true"  code="Button.Modify"/></button>
