...
<script type="text/javascript" language="javascript">
	function submitForm() {
		document.getElementById('form3').action = "constituencyMgrAction.htm";
...
<div class="clear"></div>
                ...
                <div class="frmpnlbrdr">
                 <form:form action="constituencyMgrAction.htm" id="form3" method="POST" commandName="configGovtOrderForm">
                 <input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="constituencyMgrAction.htm"/>"/>
				  <div class="frmpnlbg">
                    <div class="frmtxt" align="center">
					  ...
					  <div class="btnpnl">
                              <label>
                              <input type="button" id="btnSave" class="btn" onclick="submitForm()" value="<spring:message htmlEscape="true"  code="Button.SAVE"/>" />
							  </label>
							   <label>
