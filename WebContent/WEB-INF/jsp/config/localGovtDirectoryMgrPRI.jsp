...
<script type="text/javascript" language="javascript">
	...
	function submitForm() {
		document.getElementById('lgdmfrm').action = "lgdmFormActionPRI.htm";
...
<div class="clear"></div>
	...
	<div class="frmpnlbrdr">
		<form:form action="lgdmFormActionPRI.htm" method="POST" id="lgdmfrm"
			commandName="configGovtOrderForm">
			<input type="hidden" name="<csrf:token-name/>"
				value="<csrf:token-value uri="lgdmFormActionPRI.htm"/>" />
			<div class="frmpnlbg">
