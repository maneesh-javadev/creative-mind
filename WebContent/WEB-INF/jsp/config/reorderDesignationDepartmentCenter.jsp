...
<body>
						...
						<div class="frmtxt">
							<div class="block">
								<ul class="blocklist">
									...
									<form:select path="orgType" style="width: 200px" id="orgType" class="combofield" onchange="getOrgbyTypeAtLevel(this.value,'0','0')" htmlEscape="true">
											<form:option value="0">
								...
								<ul class="blocklist">
									<li><form:select id="olc" path="olc" style="width: 200px" class="combofield" onchange="getOrgAtLevel(this.value,0)">
											<form:option value="0">
												<spring:message htmlEscape="true" code="Label.SELECT"></spring:message>
											</form:option>
	...
	<div class="btnpnl">
		<ul class="listing">
			...
			<input type="button" name="Clear" value="Clear" onclick="go('reorder_designaton_master_center.htm');" /> 
