              ...
              <div class="box-footer">  
                <div class="col-sm-offset-2 col-sm-10">
	                 <div class="pull-right">                   
			              <button type="button" type="button" id="btnSave" onclick="submitForm()" class="btn btn-success" name="Submit"  /><spring:message htmlEscape="true"  code="Button.UPDATE"/></button>
