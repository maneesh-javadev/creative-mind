...
<script type="text/javascript" language="javascript">
	function disableButtonandSubmit() {
		...
		document.getElementById('viewlocalGovtDirectoryMgr').action = 'localGovtDirectoryMgrModify.htm';
...
<section class="content">
              <div class="row">
                   <section class="col-lg-12">
                       <div class="box">
               <form:form action="localGovtDirectoryMgrModify.htm" method="GET" commandName="configGovtOrderForm" id="viewlocalGovtDirectoryMgr">
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="localGovtDirectoryMgrModify.htm"/>"/>
                       ...
                       <c:forEach var="administratorUnit" varStatus="administratorUnitRow" items="${configGovtOrderForm.listAdminUnits}">
                            <tr >                                                  
                               <spring:bind path="configGovtOrderForm.listAdminUnits[${administratorUnitRow.index}].operationBlockValue">
										...
										<input type="hidden" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" escapeXml="true"></c:out>" htmlEscape="true"/>
										</spring:bind>
              ...
              <div class="box-footer">  
                <div class="col-sm-offset-2 col-sm-10">
	                 <div class="pull-right">                   
			             <button type="button" id="btnModify" class="btn btn-success" onclick="disableButtonandSubmit()"  /><spring:message htmlEscape="true"  code="Button.Modify"/></button>
