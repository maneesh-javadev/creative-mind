      ...
      <div class="box-header with-border">
       ...
       <div class="box-body">
             <div class="form-group">
               <label class="col-sm-3 control-label" id="lblOrgTypelIst"><spring:message htmlEscape="true" code="Label.ORGTYPELIST"></spring:message><span class="errormsg">*</span>
               ...
               <div class="col-sm-6">
                 	<form:select path="orgType" id="orgType" class="form-control" onchange="getOrgbyTypeAtLevel(this.value,'0','0')" htmlEscape="true">
						...
						<form:options items="${orgType}" itemLabel="orgType" itemValue="orgTypeCode" /></form:select>
              ...
              <div class="form-group">
               ...
               <div class="col-sm-6">
                 	<form:select id="olc" path="olc"  class="form-control" onchange="getOrgAtLevel(this.value,0)">
							<form:option value="0"><spring:message htmlEscape="true" code="Label.SELECT"></spring:message></form:option>
             ...
             <div class="form-group">
               <label class="col-sm-3 control-label" id="lblOrgLevelList"><spring:message htmlEscape="true" code="Label.ORGLEVEL"></spring:message> <span class="errormsg">*</span></label>
               <div class="col-sm-6">
                 	<select id="orgLocatedLevelCode" name="orgLocatedLevelCode" class="form-control">
						<option value="0"><spring:message htmlEscape="true" code="Label.SELECT"></spring:message></option>
					</select>
           ...
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
                	<button id="submit" class="btn btn-info" type="submit" name="Submit" onclick="return validate();"  > <spring:message htmlEscape="true"  code="Button.GETDATA"></spring:message></button>
			         <button type="button"  class="btn btn-warning" name="Clear"  onclick="go('reorder_designaton_master_center.htm');" > Clear</button>
