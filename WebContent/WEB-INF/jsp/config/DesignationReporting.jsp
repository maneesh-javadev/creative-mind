...
<div
		...
		<label> <input type="submit" name="Submit22"
				id="addLocalGovSetup" value="Add New Designation Reporting" onchange="WEB-INF/jsp/config/defineLocalGovSetup.jsp" /> </label> <label> 
				</label>
		<div class="frmtxt"
			...
			<div
				...
				class="frmhdtitle">Designation</div>
			...
			<div class="frmtxt"
				...
				<display:table style="width:900px;" cellspacing="10" cellpadding="2"
					id="data" requestURI="/DesignationReport.htm" name="listVillageDetails2"
					pagesize="2">
					<br/>
					<br/>
					<br/>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1"
						...
						<tr class="tblRowB">
							<td width="20"> <display:column
									...
									property="nomenclatureLocal" 
									title="Nomenclature Local" style="position: relative;  width: 190px; text-align: center; top: -11px; right: 12px"/>
									
									<display:column
									property="designation"  title="Designation" style="position: relative;  width: 190px; text-align: center; top: -11px; right: 12px"/>
									 <display:column
									property="reportTo"  title="Report To" style="position: relative;  width: 190px; text-align: center; top: -11px; right: 12px"/>
						</tr>
					</table>
					</tr>
					</tr>
