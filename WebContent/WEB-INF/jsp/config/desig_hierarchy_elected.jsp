...
<script type='text/javascript'
	...
	function dynamicRow(x)
	{
		dynamicDiv.innerHTML += "<div id=div"
			+ x
			+ ">"
			+ "<td><input type='text' name='desgName' onkeypress='return validateAlphanumericWithSpace(event);' maxlength='50' id='desgName"
			+ x
			+ "' class='frmfield' style='width:200px'/></td>&nbsp;&nbsp;"
			+ "<td><label id='lblreport"
			+ x
			+ "' style='color:red'/><input type='text' name='desgNameLocal' onkeypress='return validateAlphanumericWithSpace(event);' maxlength='60' id='desgNameLocal"
			+ x
			+ "' class='frmfield' style='width:200px'/></td>&nbsp;"
	...
	function ClearAll()
	{
		...
		var tierSetupCode="${tierSetupCode}";
		getDesignation(true, tierSetupCode);
...
<div id="frmcontent">
		<div class="frmhd" >
			<table width="100%" class="tbl_no_brdr">
				<tr>
					<td><spring:message htmlEscape="true"  code="Label.DHER"></spring:message>
					</td>
	...
	<form:form action="designation_hierarchy_elected.htm" method="post" commandName="designationForm" name="designationForm" id="designationForm">
	<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="designation_hierarchy_elected.htm"/>"/>
		...
		<div class="frmpnlbg">
						<div class="frmtxt">
                            ...
                            <tr>
                              ...
                              <table width="300" class="tbl_no_brdr">
                                <tr>
                                  ...
                                  <td colspan="3">
                                  <form:select name="lgTypeCode" id="lgtype" path="lgTypeCode"  onchange="getDesignation(true, this.value)">
											<form:option value=""> - - Select - - </form:option>
											<form:options items="${lgT}" itemLabel="localBodyTypeName" itemValue="localBodyTypeCode"/> 
								</form:select><div style="height:15px; padding-top:3px;" class="errormsg"></div></td>
                                </tr>
                              </table>
                              </td>
                              </tr>
						  ...
						  <table width="100%" class="tbl_no_brdr">
                            ...
                            <tr>
                              ...
                              <table width="650" class="tbl_no_brdr" id="table1">
                              <tr>
                                  <td align="left" width="200"><Label><spring:message htmlEscape="true"  code="Label.NE"></spring:message></Label><span id ="required" class="errormsg">*</span></td>
                                  <td align="left" width="200"><Label><spring:message htmlEscape="true"  code="Label.NL"></spring:message></Label><span id ="required" class="errormsg">*</span></td>
                                ...
                                <tr>
                                  <td><label id="lbldesg0" class="mndt"></label><form:input path="designationCode" name="designationCode" id="designationCode1" type="hidden" /> 
                                  <form:input path="desgName" name="desgName" id="desgName1" type="text"   onblur="isLBReportingExistingM('',1)"  maxlength="50" class="frmfield" style="width:200px" />
                                  </td>
                                  <td><label id="lblreport0" class="mndt"></label><form:input path="desgNameLocal" name="desgNameLocal"   maxlength="100"  id="desgNameLocal1" type="text" class="frmfield" style="width:200px" />
                                  </td>
                                 <td align="center">
						...
						<tr>
                              ...
                              <input type="hidden" name="isLocalBody" value="E" />
                              ...
                              <input type="submit" name="Submit" value="<spring:message htmlEscape="true"  code="Button.SAVE"></spring:message>" onclick=" return checkBoxValueDesignation()"/>
							 	 ...
							 	 <c:choose>
							 	<c:when test="${fn:containsIgnoreCase(designationForm.desigtype,'P')}"><c:set var="clearURL" value="designation_hierarchy_elected_panchayat.htm"></c:set></c:when>
								<c:when test="${fn:containsIgnoreCase(designationForm.desigtype,'T')}"><c:set var="clearURL" value="designation_hierarchy_elected_traditional.htm"></c:set></c:when>
								<c:when test="${fn:containsIgnoreCase(designationForm.desigtype,'U')}"><c:set var="clearURL" value="designation_hierarchy_elected_urban.htm"></c:set></c:when>
								 </c:choose>
