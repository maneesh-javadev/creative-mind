...
<script type="text/javascript" language="javascript">
	function submitForm() {
		document.getElementById('lgdmfrm').action = "modifyLGDMTrade.htm";
...
<div class="clear"></div>
			...
			<ul id="showhelp" class="listing">
				<li><a href="#" class="cbthelp" onclick="open_win()"><spring:message htmlEscape="true"  code="Label.CGD"></spring:message></a></li>
 				<%-- <li><a href="#" class="frmhelp"><spring:message htmlEscape="true" code="Label.HELP"></spring:message></a></li> --%>
			</ul>				    
				   </div>
                <div class="frmpnlbrdr">
				<form:form action="modifyLGDMTrade.htm" method="POST" id="lgdmfrm" commandName="configGovtOrderForm">
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="modifyLGDMTrade.htm"/>"/>
				<div class="frmpnlbg">
