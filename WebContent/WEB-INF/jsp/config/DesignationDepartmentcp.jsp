	...
	<section class="content">
                ...
                <div class="row">
                    ...
                    <form:form action="get_designation_department.htm" method="post" commandName="lgdDesignation" name="lgdDesignation" id="lgdDesignation" class="form-horizontal">
				     <input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="get_designation_department.htm"/>" />
				      <form:hidden path="designationType" htmlEscape="true" />
				      <form:hidden path="flowName" htmlEscape="true" />
                            <div class="box">
                ...
                <div class="box-body">
						...
						<div class="form-group">
						   <label  class="col-sm-3 control-label"><spring:message htmlEscape="true" code="Label.ORGTYPELIST"></spring:message><span class="mandatory">*</span> </label>
						  <div class="col-sm-6">
						      <form:select path="orgType"  id="orgType" class="form-control" onchange="getOrgbyTypeAtLevel(this.value,1,'${slcCode}')"  htmlEscape="true">
												...
												<form:options items="${orgType}" itemLabel="orgType" itemValue="orgTypeCode" htmlEscape="true" />
								</form:select>	
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
						      <form:select id="olc" path="olc"  class="form-control">
											...
											<form:options items="${organization}" htmlEscape="true" itemLabel="orgName" itemValue="orgCode" />
										</form:select>
    ...
    <div class="box-footer">
           <div class="col-sm-offset-2 col-sm-10">
                 <div class="pull-right">
				  ...
				  <button type="button" class="btn btn-warning" name="Clear" value="Clear" onclick="go('designaton_master_state.htm');" >Clear </button>
