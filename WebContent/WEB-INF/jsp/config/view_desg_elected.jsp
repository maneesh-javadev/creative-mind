...
<body>
	...
	<c:if test="${designationElected.size() > 0}">
	<%-- <c:if test="${fn:length(listVillageDetailsRow) < 0}">    --%>
	 <div class="frmtxt">
				<div  class="frmhdtitle"><spring:message htmlEscape="true"  code="Label.D"></spring:message></div>
				...
				<table width="100%"  class="tbl_no_brdr">
					...
					<tr>
						<td valign="top" class="tblclear">&nbsp;</td>
					</tr>
					<tr>
						<td valign="top" class="tblclear"><table width="100%"
								...
								<tr class="tblRowTitleBold">
									...
									<td align="lefts">Is IMultiple</td>
								</tr>


								<c:forEach var="designationElected"
									varStatus="listVillageDetailsRow"
									items="${addVillageNew.designationElected}">

									<tr class="tblRowB">
										<spring:bind htmlEscape="true"
											path="addVillageNew.designationElected[${listVillageDetailsRow.index}].NomenclatureEnglish">
										...
										<spring:bind htmlEscape="true"
											path="addVillageNew.designationElected[${listVillageDetailsRow.index}].DesignationName">
											<td>
												<option name="${status.expression}" />
												<c:out value="${status.value}" escapeXml="true"></c:out>
												</option></td>
										...
										<spring:bind htmlEscape="true"
											path="addVillageNew.designationElected[${listVillageDetailsRow.index}].DesignationNameLocal">
											<td>
												<option name="${status.expression}" />
												<c:out value="${status.value}" escapeXml="true"></c:out>
												</option></td>
										...
										<spring:bind htmlEscape="true"
											path="addVillageNew.designationElected[${listVillageDetailsRow.index}].IsTopDesignation">
											<td>
												<option name="${status.expression}" />
												<c:out value="${status.value}" escapeXml="true"></c:out>
												</option></td>
										...
										<spring:bind htmlEscape="true"
											path="addVillageNew.designationElected[${listVillageDetailsRow.index}].IsMultiple">
											<td>
												<option name="${status.expression}" />
												<c:out value="${status.value}" escapeXml="true"></c:out>
												</option></td>
					...
					<tr>
						<td height="30" colspan="3" align="right"><table width="301"
								...
								<tr>
									...
									<td width="50" align="right" class="nxt" class="tblclear"><a
										href="#">Next</a>
									</td>
									<td width="8" align="right" class="nxt" class="tblclear">&nbsp;</td>
								</tr>
							</table>
						</td>
					</tr>
	...
	</br></br><a href="designation_hierarchy_elected.htm">Add Designation Elected</a></br></br>
	</c:if>
	</c:if>
