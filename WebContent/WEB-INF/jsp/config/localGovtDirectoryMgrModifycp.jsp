...
<script type="text/javascript" language="javascript">
	function submitForm() {
		document.getElementById('lgdmfrm').action = "modifyLGDM.htm";
...
<section class="content">
              <div class="row">
                   <section class="col-lg-12">
                       <div class="box">
               <form:form action="modifyLGDM.htm" method="POST" id="lgdmfrm" commandName="configGovtOrderForm">
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="modifyLGDM.htm"/>"/>
                    ...
                    <table class="table table-bordered table-hover">
                        <tr>
						  ...
						  <th colspan="3"><center><spring:message htmlEscape="true"  code="Label.OPTIONS"> </spring:message></center></th>
						</tr>
					<tbody>
                        <c:forEach var="administratorUnit" varStatus="administratorUnitRow" items="${configGovtOrderForm.listAdminUnits}">
                            <tr >                                                  
								...
								<td>
                                 ...
                                 <input type="radio" name="<c:out value="${status.expression}"/>" value="true" <c:if test="${status.value == false}">checked</c:if> />
                                  <spring:message htmlEscape="true"  code="Label.UGO"/></label>
                              </td>
                              <td>
                               <label class="radio-inline">
              ...
              <div class="box-footer">  
                <div class="col-sm-offset-2 col-sm-10">
	                 <div class="pull-right">                   
			             <button type="button" id="btnSave" onclick="submitForm()" class="btn btn-success" name="Submit" /><spring:message htmlEscape="true"  code="Button.UPDATE"></spring:message></button>
