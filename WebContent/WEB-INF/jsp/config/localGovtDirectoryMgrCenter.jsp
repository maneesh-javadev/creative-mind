...
<div class="clear"></div>
	...
	<div class="frmpnlbrdr">
		<form:form action="lgdmFormActionCenter.htm" method="POST" id="lgdmfrm"
			commandName="configGovtOrderForm">
			<input type="hidden" name="<csrf:token-name/>"
				value="<csrf:token-value uri="lgdmFormActionCenter.htm"/>" />
			<div class="frmpnlbg">
			...
			<div class="btnpnl">
				<label> <input type="button" id="btnSave" class="btn"
					...
					value="<spring:message htmlEscape="true"  code="Button.SAVE"/>" /> </label> 
					<label> <input
