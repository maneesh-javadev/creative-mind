							...
							<div class="block">
								<ul class="blocklist">
									<li><label for="" id="lblOrgTypelIst"><spring:message htmlEscape="true" code="Label.ORGTYPELIST"></spring:message></label> <span class="errormsg">*</span>
										...
										<br><form:select path="orgType" style="width: 200px" id="orgType" class="combofield" onchange="getOrgbyTypeAtLevel(this.value,1,'${slcCode}')" htmlEscape="true">
	...
	<div class="btnpnl">
		<ul class="listing">
			<li>
				...
				<input type="button" name="Clear" value="Clear" onclick="go('designaton_master_state.htm');" /> 
