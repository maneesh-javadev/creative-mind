...
<section class="content">
	<div class="row" id="frmcontent">
		<section class="col-lg-12">
			<div class="box">
				...
				<form:form class="form-horizontal" action="modifyparliamentConstituency.htm" method="POST" commandName="parliamentbean" id="form1">
	...
	<div class="box-body">				       
		<div class="col-sm-12">
			<div class="box-header subheading"><h4><spring:message htmlEscape="true"  code="Label.MPC"></spring:message></h4></div>
									...
									<table class="table table-bordered table-striped dataTable no-footer" cellspacing="0" width="100%">
			        					<thead>
											<tr>
												...
												<th rowspan="2"><spring:message htmlEscape="true" code="Label.PARLIAMENTCONSTITUENCYNAMEINENG"></spring:message></th>
												<th rowspan="2"><spring:message htmlEscape="true" code="Label.PARLIAMENTCONSTITUENCYNAMEINLOCAL"></spring:message></th>
										   ...
										   <tbody>
											  <c:forEach var="Parliamentconstituencymodify" varStatus="listDistrictRow" items="${SEARCH_PARLIAMENT_RESULTS_KEY}">
												<tr>
													...
													<td  width="8%" align="center"><a href="#" onclick="javascript:manageParliament('viewParliamentConstituency.htm',${Parliamentconstituencymodify.constituency_code});" width="18" height="19" border="0" /><i class="fa fa-eye" aria-hidden="true"></i></a></td>
													<td  width="8%" align="center"><a href="#" onclick="javascript:manageParliament('modifyParliamentConstituency.htm',${Parliamentconstituencymodify.constituency_code});" width="18" height="19" border="0" /><i class="fa fa-pencil" aria-hidden="true"></i></a></td>														
									           </tr>
								 			 </c:forEach>	
										</tbody>
				...
				<c:if test="${fn:length(viewPage) > 0}"> 
				  <c:if test="${empty SEARCH_PARLIAMENT_RESULTS_KEY}">
					<div class="form-group" id="divData">
						<label class="col-sm-3 control-label"><spring:message htmlEscape="true"  code="error.NOPARLIAMENTFOUND"></spring:message></label>
