	   ...
	   <section class="col-lg-12 ">
		  <div class="box ">
  			  <div class="box-header with-border">
      			  <h3 class="box-title"><spring:message htmlEscape="true"  code="Label.MPC"></spring:message></h3>
  			  </div>
	      
	      <div class="box-body">
			  <div class="box-header subheading">
	              <h4><spring:message htmlEscape="true"  code="Label.MPC"></spring:message></h4>
	          </div>
              <form:form class="form-horizontal" action="modifyParliamentConstituencytAction.htm?disturb=${disturb}" method="POST" commandName="modifyParliamentConstituencyCmd" id="form1">
				 ...
				 <div id="changevillage">
					 <c:forEach var="listParliamentFormDetail" varStatus="listSubdistrictDetailsRow" items="${modifyParliamentConstituencyCmd.listParliamentFormDetail}">			
						<div class="form-group">
                   			<label  class="col-sm-3 control-label"><spring:message htmlEscape="true"  code="Label.PARLIAMENTCONSTITUENCYNAMEINENG"></spring:message><span class="mandatory">*</span> </label>
                    			<div class="col-sm-6">
								 <spring:bind path="modifyParliamentConstituencyCmd.listParliamentFormDetail[${listSubdistrictDetailsRow.index}].pcNameEnglish">							
							     	<input type="text" class="form-control" maxlength="50"  id="pcNameEnglish" path="newParliamentNameEnglish" onkeypress="validateCharKeys(event)" name="<c:out value="${status.expression}"/>"  value="<c:out value="${status.value}" escapeXml="true"></c:out>" id="subdistrictname"  onblur="constituencynameVal(this.value,'P');chekcalphabets(this.value);" htmlEscape="true" />							
				    	            <div id="UniquePCError" style="color: red;"></div>
				    	            <span class="errormsg" id="pcNameEnglish_error"><spring:message htmlEscape="true" code="Error.PARLIAMENTENTCONENGLISH"></spring:message></span>
				    	            <span><form:errors htmlEscape="true" path="newParliamentNameEnglish" class="errormsg"></form:errors></span>							
				    	        </spring:bind>
               			...
               			<div class="form-group">
                 			<label  class="col-sm-3 control-label"><spring:message htmlEscape="true"  code="Label.PARLIAMENTCONSTITUENCYNAMEINLOCAL"></spring:message></label>
                  				<div class="col-sm-6">
						 			 <spring:bind path="modifyParliamentConstituencyCmd.listParliamentFormDetail[${listSubdistrictDetailsRow.index}].pcNameLocal">	
                                         <input type="text" class="form-control" id="pcNameLocal"  maxlength="50"   onblur="validateSpecialCharactersforPCACValues(this.value,1);" name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" escapeXml="true"></c:out>" id="subdistrictname" onfocus="show_msg('subdistrictname')" onblur="subdistrictName()" htmlEscape="true" />							
                                     </spring:bind>
                  				</div>
                  			...
                  			<label  class="col-sm-3 control-label"><spring:message htmlEscape="true"  code="Label.ECICODE"></spring:message></label>
                   				<div class="col-sm-6">
									 <spring:bind path="modifyParliamentConstituencyCmd.listParliamentFormDetail[${listSubdistrictDetailsRow.index}].eciCode">							
										<input type="text" class="form-control" id="ecicode" onkeypress="return validateNumericKeys(event)" maxlength="50" onfocus="show_msg('txtAliasEnglish')"  name="<c:out value="${status.expression}"/>" value="<c:out value="${status.value}" escapeXml="true"></c:out>" />							
                            		 </spring:bind>
                   				</div>
			...
			<div class="box-footer">
	           <div class="col-sm-offset-2 col-sm-10">
	               <div class="pull-right">
                      <button type="button" id="Submit" name="Submit" class="btn btn-success" onclick="selectParliamentConstituency();"><i class="fa fa-floppy-o"></i> <spring:message htmlEscape="true"  code="Button.SAVE"></spring:message></button>
                      <button type="button" id="btnClear" name="Submit3" class="btn btn-warning" onclick="parliamentresetForm()"> <spring:message htmlEscape="true"  code="Button.CLEAR"></spring:message></button>
