...
<body>
 <section class="content">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">State Wise Parliament/Assembly Constituency to local body mapping status</h3>
                </div>
              ...
              <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                         <tr>
							<th align="left" >Expand to view district wise status</label></th>
							<th align="left" >State Name</label></th>
							<th align="left" >Total No. Of Districts</label></th>
							<th align="left" >No. Of Districts completed mapping</label></th>
							<th align="left">Percentage(%) of Districts completed mapping</label></th>
							...
							<div id="nestActionDiv">
								...
								<div style="padding-left: 20px; padding-top: 10px;"
									...
									<div style="width: 600px; height: 400px; overflow-x: auto;">
									 <div class="table-responsive ">
										<table id="workingTable" class="table table-bordered table-hover">
											<thead>
												<tr>
			   ...
			   <div class="form-group" style="text-align:center; list-style:none;"> <!-- Inline style only for Print purpose -->
                  ...
                  <div class="box-footer">                    
                    <button type="button" class=" btn btn-danger pull-right" onclick="javascript:location.href='welcome.do'"><i class="fa fa-times-circle"></i> <spring:message code="Button.CLOSE"/></button>	
                  </div>
