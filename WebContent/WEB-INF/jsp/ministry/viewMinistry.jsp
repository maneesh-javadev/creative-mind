...
<body oncontextmenu="return false" onkeypress="disableCtrlKeyCombination(event);" onkeydown="disableCtrlKeyCombination(event);">
	<div id="frmcontent">
		<div class="frmhd">
			<h3 class="subtitle"><spring:message htmlEscape="true" code="Label.VIEWMINISTRY"></spring:message></h3>
			<ul class="listing">
				<li>
					...
					<div class="frmpnlbg">
						<div class="frmtxt" align="center">
							...
							<!-- <br /> <br /> -->
								<ul class="listing">
									<li>
										<label><spring:message htmlEscape="true" code="Label.MINISTRYCODE"></spring:message></label>
									</li>
									<li>
										<label><form:input type="text" id="text1"  htmlEscape="true" onkeypress="validateNumericKeys(event)" path="code" style="width: 100px" class="frmfield" maxlength="10" /> </label>
										<form:errors path="code" class="errormsg"  htmlEscape="true" ></form:errors>
									</li>
									<li>
										<label><spring:message htmlEscape="true" code="Label.MINISTRYNAMEINENG"></spring:message></label>
									</li>
									<li>
										<label><form:input type="text" id="text2"  htmlEscape="true" onkeypress="validateCharKeys(event)" path="ministryName" style="width: 300px" class="frmfield" maxlength="200" /> </label> <form:errors path="ministryName" class="errormsg"></form:errors>
									</li>
								</ul>
