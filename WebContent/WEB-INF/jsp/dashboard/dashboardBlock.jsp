            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Block Dashboard</h4> </div>
							...
							<div class="card card-stats">
								<div class="card-header card-header-warning card-header-icon">
									<div class="card-icon pn-blue-color">
										<p class="card-category">Village not mapped with Block</p>
									</div>
								</div>
								<div class="card-body number_pos">
									<center><m1 class="number_show">{{entityList.getDashboardRevenueDetails.unmappedVillageinBlock}}</m1></center>
								</div>
								<div class="card-footer">
									<div class="stats">
										<a href="#" ng-click="showRevenueDetails('C','Invalidate Census Village')">
							...
							<div class="card card-stats">
								<div class="card-header card-header-warning card-header-icon">
									<div class="card-icon pn-orange-color">
										<p class="card-category">Block mapped with Villages of Multiple District</p>
									</div>
								</div>
								<div class="card-body number_pos">
									<center><m1 class="number_show">{{entityList.getDashboardRevenueDetails.villageMapBlockMultiDist}}</m1></center>
								</div>
								<div class="card-footer">
									<div class="stats">
										<a href="#" ng-click="showRevenueDetails('C','Invalidate Census Village')">
