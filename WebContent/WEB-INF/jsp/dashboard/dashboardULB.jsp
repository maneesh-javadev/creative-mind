            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Urban Local Bodies Dashboard</h4> </div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="card card-stats">
								...
								<div class="card-body number_pos">
									<center><m1 class="number_show">{{entityList.getDashboardRevenueDetails.unmappedVillageinLbu}}</m1></center>
								</div>
								<div class="card-footer">
									<div class="stats">
										<a href="#" ng-click="showRevenueDetails('UVLU','Village not mapped with Local Bodies')">
							...
							<div class="card card-stats">
								<div class="card-header card-header-warning card-header-icon">
									<div class="card-icon pn-yellow-color">
										<p class="card-category">ULB mapped with Multiple District</p>
									</div>
								</div>
								<div class="card-body number_pos">
									<center><m1 class="number_show">{{entityList.getDashboardRevenueDetails.ulbMapMultiDist}}</m1></center>
								</div>
								<div class="card-footer">
									<div class="stats">
										<a href="#" ng-click="showLBDetails('UMMD','ULB mapped with Multiple District')">
											<i class="fa fa-arrow-circle-right fa-2x" style="color:#0b8bcc;"></i>
											<m1 class="p-left-anchor">Get More info...</m1>
						...
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="card card-stats">
								...
								<div class="card-body number_pos">
									<center><m1 class="number_show">{{entityList.getDashboardRevenueDetails.distrubStateU}}</m1></center>
								</div>
								<div class="card-footer">
									<div class="stats">
										<a href="#" ng-click="showLBDetails('EDSU','Local Bodies in Disturbed State')">
											<i class="fa fa-arrow-circle-right fa-2x" style="color:#0b8bcc;"></i>
											<m1 class="p-left-anchor">Get More info...</m1>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-sm-6">
							<div class="card card-stats">
								...
								<div class="card-body number_pos">
									<center><m1 class="number_show">{{entityList.getDashboardRevenueDetails.invalidateLbU}}</m1></center>
								</div>
								<div class="card-footer">
									<div class="stats">
										<a href="#" ng-click="showLBDetails('IULB','Invalidate Local Bodies')">
											<i class="fa fa-arrow-circle-right fa-2x" style="color:#0b8bcc;"></i>
											<m1 class="p-left-anchor">Get More info...</m1>
