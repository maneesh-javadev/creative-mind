								...
								<table class="tbl_with_brdr" width="98%" align="center">
									<tr class="tblRowTitle tblclear">
										<td width="5%" rowspan="2"><spring:message htmlEscape="true" 
												code="Label.STATENAME" htmlEscape="true"></spring:message>
										</td>
										<td width="16%" rowspan="2"><spring:message htmlEscape="true" 
												code="Label.NUMOFTIERS" htmlEscape="true"></spring:message>
										</td>
										<td width="21%" rowspan="2"><spring:message htmlEscape="true" 
												code="Label.DISTRICTPANCHYATNME" htmlEscape="true"></spring:message>
										</td>
										<td width="21%" rowspan="2"><spring:message htmlEscape="true" 
												code="Label.INTERPANCHYATNME" htmlEscape="true"></spring:message>
										</td>
										<td width="21%" rowspan="2"><spring:message htmlEscape="true" 
												code="Label.VILLAGEPANCHYATNME" htmlEscape="true"></spring:message>
										</td>
									</tr>
										...
										<c:forEach var="panchaytSetUp" varStatus="panchaytSetUpRow"
											...
											<tr class="tblRowB">
												...
												<td width="21%" align="left"><c:out
														value="${panchaytSetUpRow.stateName}" escapeXml="true"></c:out>
												</td>
												<td colspan="6%" align="left"><c:out
														value="${panchaytSetUpRow.numberofTiers}" escapeXml="true"></c:out>
												</td>
												<td colspan="21%" align="left"><c:out
														value="${panchaytSetUpRow.districtPanchayatName}" escapeXml="true"></c:out>
												</td>
												<td colspan="21%" align="left"><c:out
														value="${panchaytSetUpRow.interMPanchayatName}" escapeXml="true"></c:out>
												</td>
												<td colspan="21%" align="left"><c:out
														value="${panchaytSetUpRow.villagePanchayatName}" escapeXml="true"></c:out>
												</td>
