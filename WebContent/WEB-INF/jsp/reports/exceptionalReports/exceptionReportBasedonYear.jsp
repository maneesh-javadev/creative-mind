     ...
     <section class="col-lg-12">
        ...
        <div class="box">
		      <div class="box-header with-border">
		        <h3 class="box-title"><c:out value="Villages which are partially mapped with more than one village level rural local bodies"/></h3>
		      </div><!-- /.box-header -->
		  ...
		  <button type="button" class="btn btn-danger " align="center" onclick="javascript:location.href='welcome.do'"><i class="fa fa-times-circle"></i> <spring:message code="Button.CLOSE"/></button>
