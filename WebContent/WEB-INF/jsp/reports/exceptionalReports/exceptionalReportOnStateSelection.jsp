...
$(document).ready(function() {
	...
	function validateCaptcha(){ 
		var state_code ,captcha ;
		if ($('#captchaAnswer').val() = '' && parseInt($('#captchaAnswer') = 0) {
		alert("Please enter the text shown above.");
		return false;
	...
	<section class="col-lg-12 prebox">
     	<div class="box">
           <div class="box-header with-border">
              <h3 class="box-title">Villages which are mapped to block but not mapped to Rural local bodies and vice versa</h3>
            </div><!-- /.box-header -->
               
                <!-- form start -->
                   <form:form class="form-horizontal" action="exceptionalReportOnStateSelectionCaptcha.do"  method="POST" id="genericReportingEntity" commandName="exceptionalReportsForm" onsubmit ="return validateCaptcha()">
               	<input type="hidden" name="<csrf:token-name/>"	value="<csrf:token-value uri="exceptionalReportOnStateSelectionCaptcha.do"/>" />
				...
				<form:hidden path="fileName" /> 
	                  ...
	                  <div class="form-group">
		                    ...
		                    <div class="form-group">
		                      ...
		                      <div class="col-sm-6">
		                      	<form:input	path="captchaAnswer" id="captchaAnswer" autocomplete="off" class="form-control" maxlength="5" onclick ="validateCaptcha()"/>
					 	...
					 	<div class="box-footer">
		                     <div class="col-sm-offset-2 col-sm-10">
		                       <div class="pull-right">
		                      		<button type="submit" class="btn btn-primary" onclick="validateCaptcha()" id="submit" ><i class="fa fa-undo"></i> <spring:message htmlEscape="true" code="Button.GETDATA"/></button>
