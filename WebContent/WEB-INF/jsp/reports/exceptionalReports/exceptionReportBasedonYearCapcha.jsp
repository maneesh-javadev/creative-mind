	...
	<section class="col-lg-12 prebox">
     	<div class="box">
           <div class="box-header with-border">
              <h3 class="box-title">Villages which are partially mapped with more than one village level rural local bodies</h3>
            </div><!-- /.box-header -->
               
                <!-- form start -->
                   <form:form class="form-horizontal" action="exceptionReportBasedonYear.do"  method="POST" id="genericReportingEntity" commandName="exceptionalReportsForm">
               	<input type="hidden" name="<csrf:token-name/>"	value="<csrf:token-value uri="exceptionReportBasedonYear.do"/>" />
