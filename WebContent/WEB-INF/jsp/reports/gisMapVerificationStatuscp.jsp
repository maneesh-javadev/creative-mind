     		...
     		<section class="col-lg-12">
       			...
       			<div class="box">
				      <div class="box-header with-border">
				        <h3 class="box-title">GIS Map Verification Status</h3>
				      </div><!-- /.box-header -->
				...
				<form:form class="form-horizontal" method="POST" action="gisMapVerificationStatus.do" commandName="viewDeptforadmin">
				<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="gisMapVerificationStatus.do"/>"/>
					<input type="hidden" id="captchaAnswer" name="captchaAnswer" value="">
						 ...
						 <div class="box-body">
		                    ...
		                    <div class="form-group">
		                      ...
		                      <div class="col-sm-6">
		                      	<input type="text" id="captcha" autocomplete="off" style="width:34%; " maxlength="5" class="form-control" />
					 ...
					 <div class="box-footer">
	                     <div class="col-sm-offset-2 col-sm-10">
	                       <div class="pull-right">
					   			<input class="btn btn-primary" type="submit" onclick="return validate();"  value="<spring:message htmlEscape="true" code="Button.GETDATA"/>" />
					...
					<c:if test="${dataExists==true}">
						<% java.text.DateFormat df = new java.text.SimpleDateFormat("dd/MM/yyyy hh:mm:ss a"); %>
							...
							<birt:viewer id="birtViewer" reportDesign="gisMapVerificationStatus.rptdesign" pattern="frameset" height="700" width="1500"   baseURL="${serverLoc}">
						...
						<div class="box-footer">
	                     <div class="col-sm-offset-2 col-sm-10">
	                       <div class="pull-right">
						  		<input class="btn btn-primary" type="button" onclick="javascript:location.href='gisMapVerificationStatus.do?<csrf:token uri='gisMapVerificationStatus.do'/>'" value="Back"/>
								<input class="btn btn-danger" type="button" value="<spring:message code="Button.CLOSE"/>" onclick="javascript:location.href='welcome.do'"/>
							</div>
						  </div>
						</div>
