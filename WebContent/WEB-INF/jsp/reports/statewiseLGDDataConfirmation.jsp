	...
	var error = false;
 	...
 	if(captcha == ""){
 		...
 		error=true;
 		 ...
 		 if(!error){
 			 callActionUrl('getStatewiseLGDDataConfirmation.do');
 		 }
 ...
 <div class="row">
	...
	<section class="col-lg-12 prebox">
     	<div class="box">
            ...
            <h3 class="box-title">Report on State wise LGD Data Confirmation</h3>
            ...
            <c:when test="${showReport eq false}">
             <form:form class="form-horizontal" action="getStatewiseLGDDataConfirmation.do" method="POST" id="genericReportingEntity" commandName="genericReportingEntity">
             <input type="hidden" name="<csrf:token-name/>"	value="<csrf:token-value uri="getStatewiseLGDDataConfirmation.do"/>" />
             <form:hidden path="screenWidth"/>
            ...
            <c:otherwise>
              ...
              <birt:viewer id="birtViewer" reportDesign="${report_design}" pattern="frameset" height="1100" width="${screenWidth}"  frameborder="no"	
              baseURL="${serverLoc}" showToolBar="false" showNavigationBar="false"></birt:viewer>
