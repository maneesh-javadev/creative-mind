	...
	<form:input path="stateId" type="hidden" name="stateId" id="stateId"  />
		...
		<div class="frmhd">
			...
			<c:if test="${!empty consolidateLBList }">
						<a id="showprint" href="#"><img src='<%=contextPath%>/images/printer_icon.png' alt="Print" border="0" onclick="PrintDiv();" /></a>
			</c:if>
		</div>
	...
	<div class="frmtxt" id="printble">
		<h6 id="statusmessage" class="title" style="font-size:18px; font-weight:bold; text-align:center; margin:0;">
			<c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'R')}">
				<spring:message code="Labl.VILLAGELVLLBIES" htmlEscape="true"></spring:message> &nbsp;<spring:message
			...
			<c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'T')}">
				<spring:message code="Label.VILLAGELVLTRADLB" htmlEscape="true"></spring:message> &nbsp;<spring:message
						code="Label.OF" htmlEscape="true"></spring:message>&nbsp;<c:out value="${consolidateReportLBRPT.state_name_english}" escapeXml="true"></c:out>
			</c:if>
		</h6>
		...
		<table class="tbl_with_brdr" width="100%" id="tbl_with_brdr">
					...
					<td width="20%" align="center"><label><spring:message
										code="Label.LOCALBODYCODE" htmlEscape="true"></spring:message> </label></td>
						...
						<c:if test="${! empty consolidateLBList}">
							<c:forEach var="panchaytSetUp" varStatus="panchaytSetUpRow"
								...
								<tr class="tblRowB">
									...
									<td width="22%" align="left"><c:out
											value="${panchaytSetUp.localbodyTypeName}" escapeXml="true"></c:out></td>
