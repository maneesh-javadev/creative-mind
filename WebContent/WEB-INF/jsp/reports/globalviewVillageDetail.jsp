     ...
     <section class="col-lg-12">
        ...
        <div class="box">
		      <%-- <div class="box-header with-border">
		        <h3 class="box-title"><spring:message code="Label.VIEWVILLAGE" htmlEscape="true"></spring:message></h3>
		      </div><!-- /.box-header --> --%>

			<form:form action="viewVillageAction.do" method="POST" commandName="villageView" id="frmModifyVillage" name="frmModifyVillage" class="form-horizontal">
			<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="viewVillageAction.do"/>" />
			...
			<%-- <div class="box-header subheading">
                  		<h4 class="box-title"><spring:message code="Label.VILLDETAIL" htmlEscape="true"></spring:message></h4>
            </div><!-- /.box-header -->				
			...
			<div class="form-group">
					  ...
					  <label class="well-inline section_info">
						...
						<div class="form-group">
						  <label  class="col-sm-6 control-label" for="sel1"><spring:message code='Label.VILLAGECODE' htmlEscape="true"/> </label>
						  <div class="col-sm-6">
							 <spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].villageCode">
						...
						<div class="form-group">
						  <label  class="col-sm-6 control-label" for="sel1"><spring:message code='Label.VILLAGEVERSION' htmlEscape="true"/> </label>
						  <div class="col-sm-6">
							  <spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].village_version">
											 <c:out value="${status.value}" escapeXml="true"></c:out>
								</spring:bind>
					  	  </div>
						</div>
						...
						<div class="form-group">
						  <label  class="col-sm-6 control-label" for="sel1"><spring:message code='Label.VILLAGENAMEINENGLISH' htmlEscape="true"/> </label>
						  <div class="col-sm-6">
							 <spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].villageNameEnglish">
								<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind>
					  	  </div>
						</div>
						...
						<div class="form-group">
						  <label  class="col-sm-6 control-label" for="sel1"><spring:message code='Label.VILLAGENAMEINLOCAL' htmlEscape="true"/> </label>
						  <div class="col-sm-6">
							 <spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].villageNameLocal">
							 <c:out value="${status.value}" escapeXml="true"></c:out>
							</spring:bind>
					  	  </div>
						</div>
						...
						<div class="form-group">
						  <label  class="col-sm-6 control-label" for="sel1"><spring:message code='Label.ALIASENGLISH' htmlEscape="true"/> </label>
						  <div class="col-sm-6">
							<spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].aliasEnglish">
								<c:out value="${status.value}" escapeXml="true"></c:out>
							</spring:bind>
					  	  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							<spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].aliasLocal">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> 
					  	  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							<spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].census2001Code">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> 
					  	  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							<spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].census2011Code">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> 
					  	  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							 <spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].sscode">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> 
					  	  </div>
						</div>
					  ...
					  <div class="well_section">
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							 <spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].orderNocr">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> 
					  	  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							<fmt:formatDate	var="orderDatecr" value="${listVillageDetails.orderDatecr}"	pattern="dd/MM/yyyy" /><c:out value="${orderDatecr}" escapeXml="true"></c:out>	
					  	  </div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
						  <fmt:formatDate var="ordereffectiveDatecr" value="${listVillageDetails.ordereffectiveDatecr}" pattern="dd/MM/yyyy" /><c:out value="${ordereffectiveDatecr}" escapeXml="true"></c:out>
						</div>
						</div>
						...
						<div class="form-group">
						  ...
						  <div class="col-sm-6">
							<fmt:formatDate var="gazPubDatecr" value="${listVillageDetails.gazPubDatecr}" pattern="dd/MM/yyyy" /><c:out value="${gazPubDatecr}" escapeXml="true"></c:out>
					  	  </div>
						</div>
			 ...
			 <!-- Reports ends  -->
				...
				<table class="table table-bordered table-hover">
                     <tbody>
                     <tr>
				      <td><spring:message code='Label.VILLAGECODE' htmlEscape="true"/></td>
						  <td><spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].villageCode">
							<c:out value="${status.value}" escapeXml="true"></c:out>
							</spring:bind></td>
					  </tr>
				       
				       <tr>
				        <td><spring:message code='Label.VILLAGEVERSION' htmlEscape="true"/></td>
				     ...
				     <td>
				     <spring:bind  path="villageView.listVillageDetails[${listVillageDetailsRow.index}].minorVersion">
				     <c:out value="${status.value}" escapeXml="true"></c:out></spring:bind></td>
				     </tr>
				        <tr>
				        <td><spring:message code='Label.VILLAGENAMEINENGLISH' htmlEscape="true"/></td>
				       ...
				       <tr>
				        <td><spring:message code='Label.VILLAGENAMEINLOCAL' htmlEscape="true"/></td>
				        ...
				        <tr>
				        <td><spring:message code='Label.ALIASENGLISH' htmlEscape="true"/></td>
				       ...
				       <tr>
				        ...
				        <td><spring:message code='Label.CENSUS2001' htmlEscape="true"/></td>
						  <td><spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].census2001Code">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind></td>
					    </tr>
				       ...
				       <tr>
				        <td><spring:message code='Label.CENSUSCODE2011' htmlEscape="true"/></td>
						  <td><spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].census2011Code">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> </td>
					    </tr>
				       <tr>
				    ...
				    <table class="table table-bordered table-hover">
				      ...
				      <tbody>
				        ...
				        <td><spring:message code='Label.ORDERNO' htmlEscape="true"/></td>
						  <td><spring:bind path="villageView.listVillageDetails[${listVillageDetailsRow.index}].orderNocr">
									<c:out value="${status.value}" escapeXml="true"></c:out>
							 </spring:bind> </td>
					    </tr>
				        ...
				        <td><spring:message code='Label.ORDERDATE' htmlEscape="true"/></td>
						  <td><fmt:formatDate	var="orderDatecr" value="${listVillageDetails.orderDatecr}"	pattern="dd/MM/yyyy" /><c:out value="${orderDatecr}" escapeXml="true"></c:out> </td>
					    </tr>
				      
				        <tr>
				        <td><spring:message code='Label.EFFECTIVEDATE' htmlEscape="true"/></td>
						  <td><fmt:formatDate var="ordereffectiveDatecr" value="${listVillageDetails.ordereffectiveDatecr}" pattern="dd/MM/yyyy" /><c:out value="${ordereffectiveDatecr}" escapeXml="true"></c:out></td>
					    </tr>
				      
				        <tr>
				        <td><spring:message code='Label.GAZPUBDATE' htmlEscape="true"/></td>
						  <td><fmt:formatDate var="gazPubDatecr" value="${listVillageDetails.gazPubDatecr}" pattern="dd/MM/yyyy" /><c:out value="${gazPubDatecr}" escapeXml="true"></c:out></td>
					    </tr>
