	  ...
	  <section class="col-lg-12 prebox">
     	<div class="box">
            <div class="box-header with-border">
               <h3 class="box-title"><spring:message htmlEscape="true" text="State wise Village to GP Mapping Status"></spring:message></h3>
...
<!-- form start -->
            <form:form class="form-horizontal" action="stateWiseGPtoVillageMappingReportB.do" id="form1" name="form1" method="POST" commandName="stateWiseGPtoVillageMappingForm">
			<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri='stateWiseGPtoVillageMappingReportB.do'/>" />
               <div id="cat">
               	<c:if test="${empty StatewiseGPtoVillageMappingList}">  
               	  <div id='viewentity'>	
					...
					<div class="box-footer">
		               <div class="col-sm-offset-2 col-sm-10">
		                 <div class="pull-right">
							<button type="submit" name="Submit" onclick="return submitData();" class="btn btn-success"><i class="fa fa-floppy-o"></i> <spring:message htmlEscape="true" code="Button.GETDATA"></spring:message></button>
	...
	<div id="divData">
	   <h6 id="statusmessage" style="font-size:18px; font-weight:bold; text-align:center; margin:0;"><spring:message htmlEscape="true" text="State wise Village to GP Mapping Status"></spring:message></h6><br />
			
		* All Villages means village with status.- Inhabitant / Un-Inhabitant / Urban / Forest <br />	
		
	  * * The states where Panchayati Raj syatem is operational are considered in this report<br />	
	 ...
	 <div class="table-responsive ">
	  <thead>
		...
		<tr>
			...
			<th style="text-align: right;"><spring:message htmlEscape="true" text="No. Of Villages Mapped to GPs"></spring:message></th>
