	...
	var error = false;
 	...
 	if(captcha == ""){
 		...
 		error=true;
 		 ...
 		 if(!error){
 			 callActionUrl('getStatewiseLastupdated.do');
 		 }
 ...
 <div class="row">
	...
	<section class="col-lg-12 prebox">
     	<div class="box">
            ...
            <h3 class="box-title">Report on State wise Last Updation Date</h3>
            ...
            <c:when test="${showReport eq false}">
             <form:form class="form-horizontal" action="getStatewiseLastupdated.do" method="POST" id="genericReportingEntity" commandName="genericReportingEntity">
             <input type="hidden" name="<csrf:token-name/>"	value="<csrf:token-value uri="getStatewiseLastupdated.do"/>" />
