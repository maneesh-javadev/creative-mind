...
function displayMap (stateCode) {
 ...
 validateReport=function(){
	 ...
	 if(!error){
		 callActionUrl('rptConsolidateforRuralLBPES.do');
	 }
            ...
            <div class="box-header with-border">
              <c:choose>
				<c:when test="${empty consolidateLBList}">
                 <h3 class="box-title"><spring:message code="Label.ConsolidatedReportForRuralLB" htmlEscape="true"></spring:message> as available in other PES applications</h3>
                </c:when>
                <c:otherwise>
                ...
                <!-- form start -->
                <form:form class="form-horizontal" commandName="consolidateReportForRuralLB" id="form1" name="form1" action="rptConsolidateforRuralLBPES.do">
					<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="rptConsolidateforRuralLBPES.do"/>" />
	                       ...
	                       <div id="displayHierarchy" style="display: none;" class="form-group">
		                      ...
		                      <div class="col-sm-6">
		                      	<form:select path="financialYear" class="form-control" id="financialYear" onchange="error_remove();">
									<form:option value="2018-2019"><spring:message htmlEscape="true" code="2018-2019"></spring:message></form:option>
									<form:option value="2017-2018"><spring:message htmlEscape="true" code="2017-2018"></spring:message></form:option>
	           ...
	           <table class="table table-striped table-bordered dataTable" id="tbl_no_brdr" >
					<thead>
						<tr>
							...
							<th style="text-align: right;"><spring:message code="Label.DISTRICTPANCHYATNME" htmlEscape="true"></spring:message></th>
							<th style="text-align: right;"><spring:message code="Label.INTERPANCHYATNME" htmlEscape="true"></spring:message></th>
							<th style="text-align: right;"><spring:message code="Label.VILLAGEPANCHYATNME" htmlEscape="true"></spring:message></th>
					...
					<tbody>
							...
							<tr>
								...
								<td width="11%" align="right">
									<c:choose>
										...
										<c:otherwise>
											<a 	href="#" onclick="javascript:manageState1('rptConsolidateforPanbyLevelRuralPES.do',${stateCode},'P','D');">
								...
								<td width="11%" align="right">
									<c:choose>
										...
										<c:otherwise>
											<c:choose>
												<c:when test="${dpLevel eq 0}">
													<a href="#" onclick="javascript:manageState2('rptConsolidateforPanbyLevelRuralPES.do',${stateCode},'P','I');"><c:out
										...
										<c:otherwise>
											<c:choose>
												<c:when test="${dpLevel eq 0 && ipLevel eq 0}">
													<a href="#" onclick="javascript:manageState3('rptConsolidateforPanbyLevelRuralPES.do',${stateCode},'P','V');">
						...
						<form:input path="stateId" type="hidden" name="stateId" id="stateId" />
							...
							<tr>
								...
								<td width="11%" align="right"><c:out value="${dpTotal}" escapeXml="true"></c:out></td>
								<td width="11%" align="right"><c:out value="${ipTotal}" escapeXml="true"></c:out></td>
								<td width="11%" align="right"><c:out value="${vpTotal}" escapeXml="true"></c:out></td>
