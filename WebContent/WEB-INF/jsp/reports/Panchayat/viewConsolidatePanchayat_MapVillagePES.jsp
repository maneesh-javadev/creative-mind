				...
				<table class="table table-striped table-bordered dataTable" width="100%" align="center" id="tbl_with_brdr">
				  <thead>
					<tr>
						...
						<th style="text-align: right"><c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'P')}"><spring:message code="Label.VILLAGECODE" htmlEscape="true"></spring:message></c:if>
						...
						<th style="text-align: right"><c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'P')}"><spring:message code="Label.CENSUSFORVILLAGE" htmlEscape="true"></spring:message></c:if>
						...
						<c:if test="${! empty consolidateLBList}">
							<c:forEach var="panchaytSetUp" varStatus="panchaytSetUpRow" items="${consolidateLBList}">
								<tr class="tblRowB">
									...
									<td width="12%" align="right"><c:out value="${panchaytSetUp[0]}" escapeXml="true"></c:out></td>
									<td width="20%" align="right"><c:out value="${panchaytSetUp[1]}" escapeXml="true"></c:out></td>
