	...
	var error = false;
 	...
 	if(captcha == ""){
 		...
 		error=true;
 		 ...
 		 if(!error){
 			 callActionUrl('getStatewiseTotalGPNPartlyMappedGP.do');
 		 }
 ...
 <div class="row">
	...
	<section class="col-lg-12 prebox">
     	<div class="box">
            ...
            <h3 class="box-title">Number of village Panchayats/Equivalent local bodies which are mapped with part of villages</h3>
            ...
            <c:when test="${showReport eq false}">
             <form:form class="form-horizontal" action="getStatewiseTotalGPNPartlyMappedGP.do" method="POST" id="genericReportingEntity" commandName="genericReportingEntity">
             <input type="hidden" name="<csrf:token-name/>"	value="<csrf:token-value uri="getStatewiseTotalGPNPartlyMappedGP.do"/>" />
