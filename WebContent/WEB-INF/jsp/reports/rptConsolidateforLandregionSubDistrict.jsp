...
<div id="frmcontent">
	<div class="frmhd">
			...
			<c:if test="${!empty consolidateLBList }">
					<a id="showprint" href="#"><img alt="Print"
							...
							<c:forEach var="panchaytSetUp" varStatus="panchaytSetUpRow"
								...
								<tr class="tblRowB">
									...
									<td  align="center"><c:out
											value="${panchaytSetUp.subdistrict_code}" escapeXml="true"></c:out>
									</td>
									<td  align="left"><c:out
											value="${panchaytSetUp.subdistrict_name_english}" escapeXml="true"></c:out>
									</td>
									
									<td  align="left"><c:out
											value="${panchaytSetUp.subdistrict_name_local}" escapeXml="true"></c:out>
									</td>
									<td align="center"><c:out
