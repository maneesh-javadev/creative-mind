...
<body>
<form:form commandName="consolidateReportLBRPT" id='form1' name="form1">
		...
		<div class="frmpnlbrdr">
			<h6 id="statusmessage" class="title" style="font-size:18px; font-weight:bold; text-align:center; margin:0;">
				...
				<c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'T')}">
					<spring:message code="Label.DISTRICTLVLTRADLB" htmlEscape="true"></spring:message>&nbsp;<spring:message
		   	...
		   	<div id="printdoc">
		   		<table class="tbl_with_brdr" width="100%" id="tbl_with_brdr">
						<tr class="tblRowTitle tblclear">
							...
							<td width="15%" align="left"><c:if
									test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'P')}">
									<label><spring:message code="Label.DISTRICTLBRPT"
							...
							<td width="15%" align="left"><c:if
									test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'P')}">
									<label><spring:message code="Label.DISTRICTLBRPTLOCAL"
											htmlEscape="true"></spring:message> </label>
								</c:if> <c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'T')}">
									<label><spring:message
											code="Label.DISTRICTLVLTRADLOCAL" htmlEscape="true"></spring:message>
									</label>
								</c:if></td>
							<td width="15%" align="center"><c:if
									test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'P')}">
									<label> <spring:message code="Label.NO.INTERPANRPT"
											htmlEscape="true"></spring:message> </label>
								</c:if> <c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'T')}">
									<label> <spring:message code="Label.NO.INTERTRADLBRPT"
											htmlEscape="true"></spring:message> </label>
								</c:if></td>
							<td width="15%" align="center"><c:if
									test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'P')}">
									<label> <spring:message code="Label.NO.VILLAGEPANRPT"
											htmlEscape="true"></spring:message> </label>
								</c:if>
								<c:if test="${fn:containsIgnoreCase(consolidateReportLBRPT.lbtype,'T')}">
						...
						<form:input path="financialYear" type="hidden"  />
							...
							<c:set var="index" value="${panchaytSetUpRow.index +1}" />
								...
								<tr class="tblRowB">
									...
									<td width="15%" align="center"><c:choose>
						...
						<tr class="tblRowTitle tblclear">
							...
							<td width="23%" align="center"><c:out
