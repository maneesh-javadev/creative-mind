					...
					<div class="box-body">
	                    <div class="form-group">
	                    	<label class="col-sm-3 control-label"><spring:message htmlEscape="true" code="Label.DISTRICTNAME"></spring:message></label>
	                      	<div class="col-sm-6"> <c:out value="${storeSubdistrictCoverageDetails[DistNameEng]}"/>
	                      	</div>
	                    </div>
							<div class="box-header subheading">
			                  <h4><spring:message htmlEscape="true"  code="Legend.GENERALDETAILOFNEWSUBDISTRICT"></spring:message><c:out value="(${draftGovermentOrderForm.formAction})" /></h4>
			                </div>
		               <table id="example" class="table table-bordered table-hover" width="100%">
										...
										<div class="box-header subheading"><h4><spring:message htmlEscape="true"  code="Label.GOVTORDERDETAILS"></spring:message></h4></div>
	                    	...
	                    	<div class="col-sm-offset-2 col-sm-10">
	                          ...
	                          <c:choose>
								<c:when test="${isView eq true }">
								 <button class="btn btn-warning" id="btnFormActionBack" type="button" value=""  onclick="callActionUrl('manageDraftSubdistrict.htm')"><spring:message htmlEscape="true" code="Button.BACK"/></button>
								</c:when>
								<c:otherwise>
