...
<body>
	<section class="content">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title"><spring:message htmlEscape="true" code="label.view.and.manage.draft.subdistrict"></spring:message></h3>
                </div>
				...
				<form:hidden path="paramCode" />
                  <table id="example"  width="100%" class="table table-bordered table-striped dataTable no-footer">
														<thead>
                  ...
                  <div class="box-footer">                    
                    <button type="submit" class="btn btn-danger pull-right" onclick="callActionUrl('home.htm')"><i class="fa fa-times-circle"></i> Close</button>
                  </div><!-- /.box-footer -->
             </form:form>
             </div>
           </section>
