...
<title><spring:message code="Label.CHANGE.EFFECTIVE.DATE.LOCALBODY" htmlEscape="true"></spring:message></title>
...
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/localbody/changeEffectiveDateController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/localbody/changeEffectiveDateChildController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/localbody/changeEffectiveDateService.js"></script>
<script  type="text/javascript" src="${pageContext.request.contextPath}/angularjs/ui-bootstrap-tpls-0.11.0.js"></script>
<script>
var _JS_lb_CODE="${lbCode}";
...
<section class="content">
	<div class="row">
		...
		<div class="box-header subheading">
		    <h4><spring:message code="Label.CHANGE.EFFECTIVE.DATE.LOCALBODY" htmlEscape="true"></spring:message></h4>
			</div>
			...
			<table class="table table-bordered table-hover" width="80%">
    			 <tbody>
			      	<tr>
			      		<td width="30%"><spring:message htmlEscape="true" code="Label.LOCALBODYCODE"> : </spring:message></td>
					    <td width="50%">{{lbDetail.entityCode}}</td>
				   </tr>
		...
		<!-- <div style="height: 40px; border: 1px solid red; background-color: #FFEBE8; padding-top: 10px;" align="center">
			...
			<table class="table table-bordered table-hover" width="80%">
    			 ...
    			 <tr>
					   ...
					   <th width="10%" ><spring:message htmlEscape="true"	code="Label.LOCALBODYCODE"></spring:message></th>
					   <th  width="20%"><spring:message htmlEscape="true" code="Label.LOCALBODYNAMEENGLISH"></spring:message></th>
					   <th width="5%">Localbody  Version</th>
					   <th width="5%">Localbody Minor Version</th>
