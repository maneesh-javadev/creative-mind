 ...
 --%>			</ul>
		...
		<div class="page_content">
			<div class="form_container">
						...
						<div class="col_1">
							...
							<ul class="form_body">
								...
								<%--<li>
									...
									<label class="inline">
										<form:radiobutton path="pesaActImpl" id="pesaActImpl" value="No" checked="true" />
				...
				<!-- Block for Habitations Started -->							
				<div class="form_block" id="habitationDiv" style="display: none;">
					<div class="col_1">
						<h4>
							<spring:message htmlEscape="true" code="Label.habiations"></spring:message>
							
						</h4>
						<ul class="form_body">
							<li>
								<input type="button" class="bttn" id="actionBuildHabitation" value="<spring:message code='Label.select.habiations' htmlEscape='true'/>"/>
								
							</li>
							<li id="habitationListDiv" style="display: none;">
										<div class="ms_container">
											<div class="ms_selectable">
				...
				<br/>
				<!-- Block for Habitations Ends Here-->
