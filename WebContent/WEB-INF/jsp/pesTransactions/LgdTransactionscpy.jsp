              ...
              <section class="col-lg-12 ">
	              	<div class="box ">
	           			<div class="box-header with-border">
	               			...
	               			<h3 class="box-title"><spring:message htmlEscape="true" code="" text=" LGD Transactions"></spring:message></h3>
	           			</div>
		                <div class="box-body">
							<form:form id="searchForm" method="POST" commandName="searchForm" name="searchForm">
				   				<input type="hidden" id="scheduleDates" name="scheduleDates"/>
				   					<div id="dataBlank" class="errormsg"></div>
										<table id="tblViewLGDTransactions" class="table table-striped table-bordered dataTable" cellspacing="0" width="100%" >
											<thead>
												<tr >
											...
											<div class="box-footer">
						                      <div class="col-sm-offset-2 col-sm-10">
						                        <div class="pull-right">
													<button type="button" id="Submit" name="Submit3" class="btn btn-success" onclick="return setScheduleDates();"><i class="fa fa-floppy-o"></i> Schedule Transaction Dates</button>	
						                        </div>
						                     </div>   
						                  </div>
					                   </c:if>
