	...
	<div id="frmcontent">
		...
		<form:form action="modifyWardAction.htm" method="POST" commandName="modifyWardCmd" id="frmModifyVillage" enctype="multipart/form-data">
			<input type="hidden" name="<csrf:token-name/>"	value="<csrf:token-value uri="modifyWardAction.htm"/>" />
		     <form:hidden path="lgd_LBNameInEn" id="oldWardName" value="${modifyWardCmd.ward_Name}" htmlEscape="true" />
		     <form:hidden path="wardCcode" id="oldWardCode" value="${modifyWardCmd.ward_number}" htmlEscape="true" />
										...
										<div class="frmpnlbg">
											<div class="frmtxt">
												<div class="frmhdtitle">
											 	...
											 	<form:hidden path="ward_code" id="hdnLbCode" value="${modifyWardCmd.ward_code}" htmlEscape="true" />
												<form:hidden path="lgd_LBTypeName" id="lbtypeName" value="${modifyWardCmd.lgd_LBTypeName}" htmlEscape="true" />
												<form:hidden path="lblc" id="lblc" value="${modifyWardCmd.lblc}" htmlEscape="true" />
												
												<%-- <form:hidden
												path="lbType" id="hdnLbTypeCode"
												value="${modifyWardCmd.lbType}"  htmlEscape="true" />  --%>
													...
													<tr>
														...
														<td width="30%"><spring:message htmlEscape="true"
															...
															class="errormsg">*</span> <br /> <form:input htmlEscape="true"
																...
																class="frmfield" onfocus="validateOnFocus('wardnumber');helpMessage(this,'wardnumberMsg');"
															...
															<div id="wardnumber_error" class="error"><spring:message code="error.blank.WARDNUMBER" htmlEscape="true"></spring:message></div>
														...
														<td width="86%">
															<div id="divSpecificState">
																<table width="570" class="tbl_no_brdr">
																	...
																	<c:if test="${! empty landRegionDistrictList}">
																	<tr>
																		<td width="235"><b><spring:message htmlEscape="true"
																					code="Label.AVAILDISTRICTLIST"></spring:message>
																		</b><br /> <form:select
																				path="lgd_LBDistCAreaSourceListUmapped"
																				class="frmtxtarea"
																				id="ddLgdWardDistrictUListSource"
																				items="${landRegionDistrictList}"
																	...
																	<c:if test="${! empty landRegionVillageList}">
																	<tr>
																		<td width="235"><b><spring:message htmlEscape="true"
																					code="Label.AVAILVILLAGELIST"></spring:message>
																		</b><br /> <form:select
																				path="lgd_LBVillageDestLatDCAUmapped"
																				class="frmtxtarea"
																				id="ddLgdWardVillageUListSource"
																				items="${landRegionVillageList}"
																				itemLabel="landRegionName"
																				itemValue="landRegionCode"
																				style="height: 110px; width: 233px" multiple="true">
