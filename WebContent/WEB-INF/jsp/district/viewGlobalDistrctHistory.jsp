...
<body >
		<div id="frmcontent">
			<div class="frmhd">
					<h2 class="Subtitle"><spring:message htmlEscape="true"  code="Label.DISTRICTHISTORY" ></spring:message></h3>
								...
								<tr>
									<td width="" align="center">
										     <tr class="tblRowTitle tblclear">
												...
												<td width="20%" rowspan="2"><spring:message htmlEscape="true" code="Label.DISTRICTCODE" text="DISTRICT CODE"></spring:message></td>
												<td width="20%" rowspan="2"><spring:message htmlEscape="true" code="Label.DISTRICTVERSION"></spring:message></td>
												<td width="40%" rowspan="2"><spring:message htmlEscape="true" code="Label.DISTRICTNAMEINENGLISH"></spring:message></td>
											...
											<%-- 	<td width="40%" rowspan="2"><spring:message htmlEscape="true" code="Label.DESCRIPTION" text="description"></spring:message></td>
												<td width="10%" rowspan="2"><spring:message htmlEscape="true" code="Label.GOVERMENTORDER" text="Government Order"></spring:message></td> --%>
								           </tr>
								<tr><td><br/></td></tr>
											 ...
											 <tr class="tblRowB">
												...
												<%-- <td align="left"><c:out value="${listDistrictDetail.description}" escapeXml="true"></c:out></td>  --%>
												<%-- <td width="10%" align="center">
												
												<a href="#"><img
																			src="images/gvt.order.png"
																			onclick="javascript:checkFileExists('${listDistrictDetail.fileLocation}','${listDistrictDetail.timeStatmp}');"
																			width="18" height="19" border="0" alt="District Details" />
												</a>
												</td> --%>
												<%-- <c:if test="${listDistrictDetail.timeStatmp ne '' }">
												<td width="10%" align="center"><a href="fileToDownloads.do?fileLocation=${listDistrictDetail.fileLocation}&timeStatmp=${listDistrictDetail.timeStatmp}&<csrf:token uri='fileToDownloads.do'/>"><img src="images/gvt.order.png" name="viewAttachment"
													width="22" height="18" alt="View" border="0"/></a>
												</td>
												</c:if>
												<c:if test="${listDistrictDetail.timeStatmp eq '' }">
