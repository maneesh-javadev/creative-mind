...
<title><spring:message code="Label.CHANGE.EFFECTIVE.DATE.DISTRICT" htmlEscape="true"></spring:message></title>
...
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/district/changeEffectiveDateController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/district/changeEffectiveDateChildController.js"></script>
<script src = "${pageContext.request.contextPath}/angularjs/changeEffectiveDate/district/changeEffectiveDateService.js"></script>
<script  type="text/javascript" src="${pageContext.request.contextPath}/angularjs/ui-bootstrap-tpls-0.11.0.js"></script>
<script>
var _JS_DISTRICT_CODE="${DistrictCode}";
...
<section class="content">
	<div class="row" >
		<section class="col-lg-12">
			<div class="box">
			<div class="box-body">
			<form class="form-horizontal" id="DsitrictForm">
		...
		<table class="table table-bordered table-hover" width="80%">
    			 <tbody>
			      	<tr>
			      		<td width="30%"><spring:message htmlEscape="true" code="Label.DISTRICTCODE"> : </spring:message></td>
					    <td width="50%">{{District_Detail.entityCode}}</td>
				   </tr>
		...
		<table class="table table-bordered table-hover" width="80%">
    			 ...
    			 <tr>
					   ...
					   <th width="10%" ><spring:message htmlEscape="true"	code="Label.DISTRICTCODE"></spring:message></th>
					   <th  width="20%"><spring:message htmlEscape="true" code="Label.DISTRICTNAMEINENGLISH"></spring:message></th>
					   <th width="5%">District  Version</th>
					   <th width="5%">District Minor Version</th>
