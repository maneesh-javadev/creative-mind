              ...
              <section class="col-lg-12 ">
	              	<div class="box ">
		                ...
		                <div class="box-body">
		                    ...
		                    <form:form action="viewDistrictAction.htm" class="form-horizontal" method="POST" commandName="districtModifyView" id="frmViewModifyDistrict">

								<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value uri="viewDistrictAction.htm"/>"/>
					            
					
								<c:forEach var="listDistrictDetails" varStatus="listDistrictDetailsRow" items="${districtModifyView.listDistrictDetails}">
									...
									<table class="table table-bordered table-hover">
									    ...
									    <tbody>
									      <tr>
									        ...
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].districtCode">&nbsp;
									      ...
									      <tr>
									        ...
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].districtVersion">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out></spring:bind></td>
									      </tr>
									      <tr>
									        <td><spring:message htmlEscape="true"  code="Label.DISTRICTNAMEENG"></spring:message></td>
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].districtNameEnglish">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out></spring:bind></td>
									      </tr>
									      <tr>
									        <td><spring:message htmlEscape="true"  code="Label.DISTRICTNAMELOCAL"></spring:message></td>
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].districtNameLocal">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out></spring:bind></td>
									      </tr>
									      <tr>
									        <td><spring:message htmlEscape="true"  code="Label.DISTRICTALIASENGLISH"></spring:message></td>
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].aliasEnglish">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out></spring:bind> </td>
									      </tr>
									      <tr>
									        <td><spring:message htmlEscape="true"  code="Label.DISTRICTALIASLOCAL"></spring:message></td>
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].aliasLocal">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out></spring:bind></td>
									      </tr>
									      <tr>
									        <td><spring:message htmlEscape="true"  code="Label.HEADQUARTER"></spring:message></td>
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].headquarterName">&nbsp;							
				                                    <c:out value="${status.value}" escapeXml="true"></c:out></spring:bind></td>
									      </tr>
									      
									      <tr>
									        <td><spring:message htmlEscape="true"  code="Label.STATESPECIFICCODE"></spring:message></td>
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].sscode">&nbsp;
									      ...
									      <tr>
									        ...
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].orderNocr">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out>
											   		</spring:bind></td>
									      </tr>
									      ...
									      <tr>
									        ...
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].orderDatecr">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out>
											   		</spring:bind></td>
									      </tr>
									      ...
									      <tr>
									        ...
									        <td><spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].ordereffectiveDatecr">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out>
											  		</spring:bind></td>
									      </tr>
									      ...
									      <tr>
									        ...
									        <td>
									        	<spring:bind path="districtModifyView.listDistrictDetails[${listDistrictDetailsRow.index}].gazPubDatecr">&nbsp;
													<c:out value="${status.value}" escapeXml="true"></c:out>
										   		</spring:bind>
									   		</td>
									      </tr>
