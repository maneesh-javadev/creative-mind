...
<section class="content">
	<div class="row">
		...
		<div class="box">
		      <div class="box-header with-border">
		        <h3 class="box-title"><spring:message code="Label.freeze.landregions" text="Freeze Land Regions"/></h3>
		  </div><!-- /.box-header -->
			...
			<%-- <div class="box-header subheading">
				...
				<form:form commandName="freezeDistrict" action="freezeDistrict.htm" method="post" id="freezeDistrict" class="form-horizontal"> 	
	...
	<div id="divExistingDraftVillageDeatils" class="form_stylings" style="display: none;">
		<div class="form_block">
				<div class="col_1">
					<h4><c:out value="${freezePRI.districtNameEnglish} district can't be freeze because below villages are in drafted mode. In order to Freeze this district first take action on below Villages." /></h4>
					<ul class="form_body">
						<li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" id="customAlertbody">
         <div class="form_block">
				<div class="col_1">
					<h4><c:out value="${freezePRI.districtNameEnglish} district can't be freeze because below Local Bodies are in ${headingMessage}.In order to Freeze this district first take action on below Local Bodies."></c:out> </h4>
					<ul class="form_body">
						<li>
							<table id="tblGornmentOrderDetails" class="data_grid" width="100%">
								<thead>
