		...
		<div id="frmcontent">
			<div class="frmhd">
				<table width="100%" class="tbl_no_brdr">
					<tr>
						<td><spring:message htmlEscape="true"  code="Label.VIEWDISTHIST"></spring:message></td>
											...
											<tr><td><br/></td></tr>
									         ...
									         <c:forEach var="districtHistoryDetail" varStatus="listDistrictRow" items="${districtHistory}">
												  <tr class="tblRowB">
									                    ...
									                    <td align="left"><c:out value="${districtHistoryDetail.lrReplaces}" escapeXml="true"></c:out></td>
