 		...
 		<div id="frmcontent">
					<div class="frmhd">
					  ...
					  <table width="100%" class="tbl_no_brdr">
                        <tr>
                          <td><spring:message htmlEscape="true"  code="Label.MODIFYSUBDISTRICT"></spring:message> </td>
                          <td>&nbsp;</td>
					...
					<form:form action="" method="POST" commandName="modifySub" id="frmModifySubDistrict" enctype="multipart/form-data">
							  <div class="frmpnlbg">
							 
                                <div class="frmtxt">
                                  <div class="frmhdtitle"><spring:message htmlEscape="true"  code="Label.MODIFYSUBDISTRICTOPTION"></spring:message></div>
							  ...
							  <div class="frmtxt">
								  ...
								  <c:forEach var="listSubdistrictDetails" varStatus="listSubdistrictDetailsRow" items="${modifySubDistrictCmd.listSubdistrictDetails}">
                                    ...
                                    <tr>
                                      <td><spring:message htmlEscape="true"  code="Label.SUBDISTRICTNAMELOCAL"></spring:message><br />
                                          <label>
                                    ...
                                    <tr>
                                      <td><spring:message htmlEscape="true"  code="Label.SUBDISTRICTALIASENGLISH"></spring:message><br />
                                          <label>
                                    ...
                                    <tr>
                                      <td><spring:message htmlEscape="true"  code="Label.SUBDISTRICTALIASLOCAL"></spring:message><br />
                                          <label>
                                      ...
                                      <tr>
                                      <td><spring:message htmlEscape="true"  code="Label.HEADQUARTER"></spring:message><br />
                                          <label>
                                        ...
                                        <tr>
                                         ...
                                         <label>
                                          ...
                                          <spring:bind path="modifySubDistrictCmd.listSubdistrictDetails[${listSubdistrictDetailsRow.index}].lati">							
                                            ...
                                            <td width="171" ><spring:message htmlEscape="true"  code="Label.LONGITUDE"></spring:message><br/>
                                            <label>
							...
							<table width="100%" class="tbl_no_brdr" align="center">
								...
								<tr>
									<td ><spring:message htmlEscape="true"  code="Label.ORDERNO"></spring:message><br />
									<label>
							  ...
							  <div class="frmtxt">
								  ...
								  <c:forEach var="listSubdistrictDetails" varStatus="listSubdistrictDetailsRow" items="${modifySubDistrictCmd.listSubdistrictDetails}">
                                    <tr>
                                      ...
                                      <td width="86%"><spring:message htmlEscape="true"  code="Label.SUBDISTRICTNAMEENGLISH"></spring:message><span class="errormsg">*</span><br />
                                          <label>
								...
								<tr>
									...
									<td width="86%"><spring:message htmlEscape="true"  code="Label.ORDERNO"></spring:message><span class="errormsg">*</span><br />
										...
										<span class="msg" id="OrderNo_msg"><spring:message htmlEscape="true"  code="Msg.ORDERNO"></spring:message></span><span class="error" id="OrderNo_error"></span>
                    ...
                    calendar12 = new dynCalendar('calendar12', 'exampleCallback_ISO12','<%=contextPath%>/images/');
								...
								<tr>
									<td><spring:message htmlEscape="true"  code="Label.UPLOADGOVTORDER"></spring:message><span class="errormsg">*</span><br />
										...
										<spring:message htmlEscape="true"  code="Msg.UPLOADGOVTORDER"></spring:message> </span>
						    ...
						    <div class="btnpnl">
                              <table width="100%" class="tbl_no_brdr">
                                <tr>
                                  <td><label>
                                    <input type="submit" class="btn" name="Submit" value="<spring:message htmlEscape="true"  code="Button.UPDATE"></spring:message>"/>
                                    </label>
                                     <!--  <label>
