...
(function($) {
	...
	$.alerts = {
		...
		_show: function(title, msg, value, type, callback) {
			...
			switch( type ) {
				case 'alert':
					$("#popup_message").after('<div id="popup_panel"><input type="button" class ="groovybutton" onMouseOver="goLite(this.form.name,this.name)" onMouseOut="goDim(this.form.name,this.name)" value="' + $.alerts.okButton + '" id="popup_ok" /></div>');
	...
	jAlert = function(message, title, type,callback) {
		$.alerts.alert(message, title, type, callback);
	};
	jErrorAlert = function(message, title, focusElementId) {
		$.alerts.alert(message, title, "error", function(){$("#"+focusElementId).focus();});
	};
	jSuccessAlert = function(message, title,type, callback) {
		$.alerts.alert(message, title, type, callback);
	};
