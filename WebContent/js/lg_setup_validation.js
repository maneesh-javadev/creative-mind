...
//Name in English 
function txtNE(txtNE)
{
	
	if(document.getElementById("txtNE").value == "" )
	{
		
		document.getElementById("txtNE_error")
		.innerHTML="Name In English required";
		$("#txtNE_error").show();
		$("#txtNE_msg").hide();
		$("#txtNE").addClass("error_fld");
		$("#txtNE").addClass("error_msg");
		return false;

	}
	else if(document.getElementById("txtNE").value.length<60)
	{
		document.getElementById("txtNE_error")
		.innerHTML="Name (In English) should  not exceed 60 characters.";
		$("#txtNE_msg").hide();
		$("#txtNE_error").show();
		$("#txtNE").addClass("error_fld");
		$("#txtNE").addClass("error_msg");
...
function txtNL(txtNL)
{
	
	if(document.getElementById("txtNL").value == "" )
	{
		
		document.getElementById("txtNL_error")
		.innerHTML="Name In English required";
		$("#txtNL_error").show();
		$("#txtNL_msg").hide();
		$("#txtNL").addClass("error_fld");
		$("#txtNL").addClass("error_msg");
		return false;
	...
	else if(document.getElementById("txtNE").value.length>60)
	{
		...
		document.getElementById("txtNL_error")
		.innerHTML="Name (In Local) should  not exceed 60 characters.";
		$("#txtNL_msg").hide();
		$("#txtNL_error").show();
		$("#txtNL").addClass("error_fld");
		$("#txtNL").addClass("error_msg");
