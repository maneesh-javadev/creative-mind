...
function merge1() {
	...
	if (mergelocalbody == 0) {
		alert("Please Select District Panchayat Localbody ");
...
function merge2() {
	...
	if (mergelocalbody == 0) {
		alert("Please Select Intermediate Panchayat  Localbody ");
...
function validateform() {
	...
	if (document.getElementById('show_dp').checked) {
		...
		if (!document.getElementById('chooseMoreBtn').disabled) {
			alert('Please Select Child Localbody to merge with target LocalBody');
			return false;
		}
...
function prevalidate() {
	...
	if (id == 1) {
		...
		if (dp == 0) {
			alert("Please Select District Panchyat to Delete");
			success = false;
		...
		if (dp == 0 && tiertype != 2) {
			alert("Please Select District Panchyat");
			success = false;
		} else {
			lblist2 = document.getElementById('lblist2').value;

			if (lblist2 == 0 && tiertype != 2) {
				if (id == 2)
					alert("Please Select Intermediate Panchyat to Delete");
				else if (type == 2)
					alert("Please Select Village Panchyat to Delete");
				success = false;
			} else if (document.getElementById('show_dp').checked == false && document.getElementById('hide_dp').checked == false) {
				alert("Please Select Option Value");
				success = false;
		...
		if (dp == 0) {
			...
			alert("Please Select Intermediate Panchyat");
			success = false;
		} else {
			lblist2 = document.getElementById('lblist3').value;

			if (lblist2 == 0) {
				alert("Please Select Gram Panchyat to Delete");
				success = false;
			} else if (document.getElementById('show_dp').checked == false && document.getElementById('hide_dp').checked == false) {
				alert("Please Select Option Value");
				success = false;
