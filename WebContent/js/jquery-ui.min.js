										...
										init : function() {
											...
											if (o.handles.constructor == String) {
												...
												for ( var i = 0; i < n.length; i++) {
													var handle = $.trim(n[i]), dt = o.defaultTheme, hname = 'ui-resizable-'
															+ handle, loadDefault = !$.ui
															.css(hname)
							...
							if (init) {
								...
								if (o.selected === undefined) {
									if (location.hash) {
										...
										var index = parseInt($.cookie('ui-tabs'
					...
					Datepicker.prototype,
					{
						...
						_generateDatepicker : function(inst) {
							...
							var controls = '<div class="ui-datepicker-control">'
									...
									+ (showStatus ? this._addStatus(inst, this
											._get(inst, 'closeStatus')
											|| '&#xa0;') : '')
									+ '>'
							...
							var prev = '<div class="ui-datepicker-prev">'
									+ (this._canAdjustMonth(inst, -1, drawYear,
						...
						_generateMonthYearHeader : function(inst, drawMonth,
							...
							if (secondary || !this._get(inst, 'changeMonth'))
								...
								html += '<select class="ui-datepicker-new-month" '
										...
										+ inst.id
										+ '\');"'
										+ (showStatus ? this._addStatus(inst,
