...
function ValidateAndSubmitforupdate() {
	if (minimumChangesformodifyAdminUnit()) {
		...
		if (obj.length == 0) {
			status = false;
			document.getElementById("UniqueDeptAdminError").innerHTML = "<font color='red'>Please Enter Revenue Level (In English)</font>";

		} else if (index == 0) {
			status = false;
			document.getElementById("parentAdminUnit").innerHTML = "<font color='red'>Please Select Parent Revenue Level </font>";
...
function handleUniqueAdminSuccess(data) {
	if (!data) {
		document.getElementById("UniqueDeptAdminError").innerHTML = "<font color='red'>An Revenue Level already exists with same name </font>";
...
function chekNameValidatons(inputtxt) {
	...
	if (val.length == 0) {
		document.getElementById("UniqueDeptAdminError").innerHTML = "<font color='red'>Please Enter Revenue Name</font>";
		return false;
	}
	if (inputtxt.match(/\S/)) {
		var letterNumber = "";
...
function ValidateAndSubmit() {
	...
	if (obj.length == 0) {
		status = false;
		document.getElementById("UniqueDeptAdminError").innerHTML = "<font color='red'>Please Enter the name of new Revenue Level in English</font>";
	} else if (index == 0) {
		status = false;
		document.getElementById("parentAdminUnit").innerHTML = "<font color='red'>Please Select Parent Revenue Level </font>";
...
function ValidateAndSubmitPublish() {
	...
	if (status) {
		document.getElementById('buttonClicked').value = 'L';
		$('input[name=Submit]').prop('disabled', true);
		$('input[name=Publish]').prop('disabled', true);
		document.getElementById('form1').action = 'saveDepartmenAdmitUnits.htm';
		document.getElementById('form1').submit();
...
function handleChildRecSuccesUnit(data) {
	if (!data) {
		alert("The Revenue level is currently in use and cannot be deleted");
...
function ValidateAndSubmitforEntity(type) {
	...
	if (index == 0) {
		status = false;
		document.getElementById("parentAdminUnitLevel").innerHTML = "<font color='red'>Please Select Parent Revenue Level</font>";
...
function chekNameValidatonsforEntity(inputtxt) {
	...
	if (unitLevel == -1) {
		document.getElementById("parentAdminUnitLevel").innerHTML = "<font color='red'>Please Select Revenue Level, Parent Entity</font>";
		document.getElementById("adminLevelNameEng").value = "";
		return false;
	} else if (parentCode == -1) {
		document.getElementById("parentAdminUnit").innerHTML = "<font color='red'>Please Select Revenue Entity</font>";
		document.getElementById("adminLevelNameEng").value = "";
		return false;
	}
...
function ValidateAndSubmitforEntityupdate() {
	if (minimumChangesformodifyAdminEntity()) {
		...
		if (obj.length == 0) {
			status = false;
			document.getElementById("UniqueDeptAdminError").innerHTML = "<font color='red'>Please Enter Revenue Entity (In English)</font>";

		} else if (index == 0) {
			status = false;
			document.getElementById("parentAdminUnit").innerHTML = "<font color='red'>Please Select Revenue Level </font>";

		} else if (parentoldIndex > 0) {
			if (parentNewIndex == 0) {
				status = false;
				document.getElementById("parentAdminUnitforEntity").innerHTML = "<font color='red'>Please Select Parent Revenue Level </font>";
			}
...
function validateEntityChildExist(adminUnitCode) {
	var slc = document.getElementById("stateCode").value;
	var deptUnitName = null;
	var type = 'D';
	document.getElementById("unitCode").value = adminUnitCode;
...
function handleChildRecSuccesEntity(data) {
	if (!data) {
		alert("The Revenue Entity is currently in use and cannot be deleted");
...
function toggleCovergeDiv() {
	...
	if (index1 == 0) {
		status = true;
		document.getElementById("parentAdminUnit").innerHTML = "<font color='red'>Please Select Parent level Revenue Level</font>";
	}
	if (obj.length == 0) {
		status = true;
		document.getElementById("UniqueDeptAdminError").innerHTML = "<font color='red'>Please Enter the name of new Revenue Entity in English</font>";
