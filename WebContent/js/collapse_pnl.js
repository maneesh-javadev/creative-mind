...
function hideWrraper() {
	...
	var leftpanel = document.getElementById("leftpnl");
	var colImg = document.getElementById("collapseImg");
	var colSpanToShow = document.getElementById("span_1_0");
	if (obj.style.display != "none") {
		obj.style.display = 'none';
		colSpanToShow.style.display = 'block';
		colImg.src = "images/collapse.jpg";
		rightpanel.style.marginLeft = "15px";
		leftpanel.style.width = "10px";
	} else {
		obj.style.display = 'block';
		colSpanToShow.style.display = 'none';
		colImg.src = "images/collapse.jpg";
		rightpanel.style.marginLeft = "250px";
		leftpanel.style.width = "245px";
	}
}
...
function setIframeHeight(iframeName) {
	...
	if (iframeEl) {
		iframeEl.style.height = "auto"; // helps resize (for some) if new doc
