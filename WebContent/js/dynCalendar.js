...
* Last Modified..: $Date: 2009/03/04 10:28:08 $
...
//		this.imagesPath     = arguments[2] ? arguments[2] : 'http://w07/qms/js/';
        ...
        */
		...
		this.setFutureYearCombo = dynCalendar_setFutureYearCombo;
	...
	function dynCalendar_show()
	{
        ...
        */
		if (this.useYearCombo) {
			...
			for (i = thisMonth.getFullYear() - this.yearComboRange; i <= (thisMonth.getFullYear()); i++) {
		...
		}else if(this.useFutureYearCombo){
			yearComboOptions = '';
			//for (i = thisMonth.getFullYear() - this.yearComboRange; i <= (thisMonth.getFullYear() + this.yearComboRange); i++) {
...
*/
	function dynCalendar_writeHTML()
	{
		if (is_ie5up || is_nav6up || is_gecko) {
			document.write('<a href="javascript: ' + this.objName + '.show()"><img src="' + this.imagesPath + 'dynCalendar.gif" border="0" width="20" height="22" /></a>');
...
*/
	...
	function dynCalendar_setFutureYearCombo(useFutureYearCombo)
	{
		this.useFutureYearCombo = useFutureYearCombo;
	}
/**
...
*/
	...
	{/*
		...
		this._getLayer().style.left =(this._mouseDownEvent.pageX - this.offsetX)+ 'px';
		this._getLayer().style.top =(this._mouseDownEvent.pageY - this.offsetY)+ 'px';
	}
