...
import in.nic.pes.lgd.restructure.reporting.entities.LocalBodyMappedToDistrictsEntity;
 ...
 public interface ReportDAO {
	...
	List<GetLocalBodyListbyLBtypebyState> getLocalBodyListbyLBtypebyState(int stateCode, char type, char level, int parentLBCode) throws Exception;
	 ...
	 List<ConsolidateReportLandregions> getConsolidatedRptForLandregion() throws Exception;

	 List<ConsolidateReportLandregionsforDistrict> getLocalBodyListbyLBtypebyState(int slc) throws Exception;

	 List<ConsolidateReportLandregionsforSubDistrict> getLocalBodyListbysubdistic(int stateCode, int district_code) throws Exception;

	 List<ConsolidateReportLandregionsforVillage> getLocalBodyListbyvillage(int subdistrict_code) throws Exception;
	 ...
	 List<DPwardConstituencyWiseVP> getDPwardConstituencyWiseVP(Integer state_code) throws Exception;
	 ...
	 List<LandRegionDetail> getEntitywiseParentDetails(String entityType,Integer entityCode) throws Exception;
