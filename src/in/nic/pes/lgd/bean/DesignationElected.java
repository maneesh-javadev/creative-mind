 ...
 */
@Entity
@NamedNativeQuery(query = "select * from designation_setup_fn(:state,:islocalbody)", name ="DesignationElected", resultClass = DesignationElected.class)

public class DesignationElected implements Serializable {
