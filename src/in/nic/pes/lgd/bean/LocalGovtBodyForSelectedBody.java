...
@Entity
@NamedNativeQuery(query="SELECT * FROM getlblist(:localBodyTypeCode, :stateCode)",name="getLocalBodyListForSelectedBody1",resultClass=LocalGovtBodyForSelectedBody.class)

public class LocalGovtBodyForSelectedBody {
