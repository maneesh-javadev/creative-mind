...
@Entity
@Table(name = "ws_registered_IPs")
public class WsRegisteredIpEntity implements Serializable {
	private static final long serialVersionUID = 1L;
	@GenericGenerator(name = "sequence", strategy = "sequence", parameters = { @Parameter(name = "sequence", value = "ws_registered_IPs_srno_seq") })
	@Id
